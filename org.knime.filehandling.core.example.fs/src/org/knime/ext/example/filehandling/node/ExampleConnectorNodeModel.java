...
/**
 * Node model for the Example Connector.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 */
class ExampleConnectorNodeModel extends NodeModel {
    private static final String FILE_SYSTEM_NAME = "example";

    private String m_fsId;
    private ExampleFSConnection m_fsConnection;
    private final ExampleConnectorSettings m_settings;

    /**
     * Creates new instance.
     */
    protected ExampleConnectorNodeModel() {
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        try {
            m_fsConnection = new ExampleFSConnection(config);
