...
/**
 * Iterator to iterate through {@link ExamplePath}.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 */
class ExamplePathIterator extends BasePathIterator<ExamplePath> {
     ...
     * @throws IOException
     */
    ExamplePathIterator(final ExamplePath path, final Filter<? super Path> filter) throws IOException {
        super(path, filter);

        try {
            // FIXME: list directory contents and supply it with iterator
            Iterator<ExamplePath> iterator = null;
