...
import org.knime.ext.example.filehandling.testing.ExampleFSTestInitializerProvider;
...
/**
 * {@link FSDescriptorProvider} for the Example file system.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 */
public class ExampleFSDescriptorProvider extends BaseFSDescriptorProvider {

    /**
     * {@link FSType} for the Example file system.
     */
    public static final FSType FS_TYPE = FSTypeRegistry.getOrCreateFSType("example", "Example");

    /**
     * Constructor.
     */
    public ExampleFSDescriptorProvider() {
        super(FS_TYPE, new BaseFSDescriptor.Builder() //
                .withConnectionFactory((final ExampleFSConnectionConfig config) -> new ExampleFSConnection(config)) // NOSONAR
                .withSeparator(ExampleFileSystem.SEPARATOR) //
                .withURIExporterFactory(URIExporterIDs.DEFAULT, PathURIExporterFactory.getInstance()) //
                .withTestInitializerProvider(new ExampleFSTestInitializerProvider()) //
                .build());
    }
}
