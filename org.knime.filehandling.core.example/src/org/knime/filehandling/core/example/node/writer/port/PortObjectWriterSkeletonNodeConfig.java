...
final class PortObjectWriterSkeletonNodeConfig extends PortObjectWriterNodeConfig {
	...
	@Override
	protected void saveConfigurationForModel(NodeSettingsWO settings) {
		m_example.saveSettingsTo(settings);
		super.saveConfigurationForModel(settings);
	}

	@Override
	protected void loadConfigurationForModel(NodeSettingsRO settings) throws InvalidSettingsException {
		m_example.loadSettingsFrom(settings);
		super.loadConfigurationForModel(settings);
	}

	@Override
	protected void validateConfigurationForModel(NodeSettingsRO settings) throws InvalidSettingsException {
