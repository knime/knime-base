...
public class TableWriterSkeletonNodeFactory extends ConfigurableNodeFactory<TableWriterSkeletonNodeModel> {
	...
	@Override
	protected TableWriterSkeletonNodeModel createNodeModel(NodeCreationConfiguration creationConfig) {
	...
	@Override
	public NodeView<TableWriterSkeletonNodeModel> createNodeView(int viewIndex,
			TableWriterSkeletonNodeModel nodeModel) {
		return null;
	}
