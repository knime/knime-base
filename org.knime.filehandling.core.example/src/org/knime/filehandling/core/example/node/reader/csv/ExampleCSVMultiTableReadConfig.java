...
/**
 * {@link MultiTableReadConfig} for the Example CSV reader. This class serves two purposes:
 * <ul>
...
final class ExampleCSVMultiTableReadConfig extends
    ...
    ExampleCSVMultiTableReadConfig() {
        ...
        config.setUseColumnHeaderIdx(true);
    ...
    @Override
    protected ExampleCSVMultiTableReadConfig getThis() {
        return this;
    }
