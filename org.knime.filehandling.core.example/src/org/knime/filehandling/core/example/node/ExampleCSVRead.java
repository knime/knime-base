...
final class ExampleCSVRead implements Read<String> {
    ...
    private final TableReadConfig<ExampleCSVReaderConfig> m_config;

    private final ExampleCSVReaderConfig m_csvReaderConfig;
    ...
    ExampleCSVRead(final FSPath path, final TableReadConfig<ExampleCSVReaderConfig> config) throws IOException {
        m_config = config;
        m_csvReaderConfig = m_config.getReaderSpecificConfig();
    ...
    public RandomAccessible<String> next() throws IOException {
        ...
        if (line == null) {
            ...
            return RandomAccessibleUtils.createFromArray(line.split(LINE_SPLITTER));
        }
    }
