...
public final class TableColumnToVariable3NodeFactory extends NodeFactory<TableColumnToVariable3NodeModel> {
    ...
    @Override
    public TableColumnToVariable3NodeModel createNodeModel() {
        return new TableColumnToVariable3NodeModel();
    }
    ...
    @Override
    public NodeView<TableColumnToVariable3NodeModel> createNodeView(final int viewIndex,
        final TableColumnToVariable3NodeModel nodeModel) {
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new TableColumnToVariable3NodeDialog();
    }
}
