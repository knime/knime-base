...
public class Statistics3NodeModel extends NodeModel {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        try (final CloseableTable table = getStatTable().createNominalValueTable(m_nominalFilter.getIncludeList())) {
        	return new BufferedDataTable[]{outTable1, exec.createBufferedDataTable(table, exec.createSubProgress(0.5))};
        }
    }
