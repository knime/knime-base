...
import org.knime.base.node.preproc.pmml.numbertostring3.NumberToString3NodeDialog;
 ...
 * @deprecated Use {@link NumberToString3NodeDialog} instead
 */
@Deprecated
public class NumberToStringNodeDialog extends DefaultNodeSettingsPane {
    ...
    public NumberToStringNodeDialog() {
        addDialogComponent(new DialogComponentColumnFilter(
                NumberToStringNodeModel.createInclModel(), 0, true, DoubleValue.class));
    }
}
