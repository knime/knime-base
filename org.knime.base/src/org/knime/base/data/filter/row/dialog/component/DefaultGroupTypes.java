...
public final class DefaultGroupTypes {
    ...
    /**
     * The {@code AND} group type.
     */
    public static final GroupType AND = new GroupType("and", "AND");

    /**
     * The {@code OR} group type.
     */
    public static final GroupType OR = new GroupType("or", "OR");

    private DefaultGroupTypes() {
