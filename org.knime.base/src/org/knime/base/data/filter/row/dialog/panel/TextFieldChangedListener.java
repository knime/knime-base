...
public class TextFieldChangedListener implements DocumentListener {
    ...
    /**
     * Constructs a {@link TextFieldChangedListener} object.
     *
     * @param onChanged an action for trigerred on any changes; noy null.
     */
    public TextFieldChangedListener(final Runnable onChanged) {
        m_onChanged = Objects.requireNonNull(onChanged);
    }
