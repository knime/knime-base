...
public class Operator {
    ...
    /**
     * Constructs a {@link Operator}.
     *
     * @param id the ID, not {@code null}
     * @param name the name of operator to show on UI, not {@code null}.
     */
    public Operator(final String id, final String name) {
        m_id = Objects.requireNonNull(id, "id");
    ...
    public String toString() {
        return "Operator [m_id=" + m_id + ", m_name=" + m_name + "]";
    }
