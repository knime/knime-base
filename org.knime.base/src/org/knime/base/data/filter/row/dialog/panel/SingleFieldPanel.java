...
public class SingleFieldPanel extends AbstractFieldPanel {
    ...
    private static final long serialVersionUID = 7393915727761639765L;
    ...
    public void init(final OperatorPanelParameters parameters) {
        ...
        m_textField.setText(values == null || values.length == 0 ? "" : values[0]);
    }

    @Override
    public String[] getValues() {
        return new String[]{m_textField.getText()};
    }
