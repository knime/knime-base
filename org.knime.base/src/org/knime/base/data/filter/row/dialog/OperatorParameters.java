...
public class OperatorParameters {
    ...
    /**
     * Constructs a {@link OperatorParameters}.
     *
     * @param columnSpec the database column specification
     * @param operator the {@link Operator}
     * @param values the operands
     */
    public OperatorParameters(final ColumnSpec columnSpec, final Operator operator, final String[] values) {
        m_columnSpec = Objects.requireNonNull(columnSpec, "columnSpec");
        m_operator = Objects.requireNonNull(operator, "operator");
        m_values = values;
    }

    /**
     * Gets the database column specification.
     *
