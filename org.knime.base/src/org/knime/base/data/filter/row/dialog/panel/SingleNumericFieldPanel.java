...
/**
 * A single spinner field for numerical values.
 *
 * @author Perla Gjoka, KNIME GmbH, Konstanz, Germany
 * @since 4.1
 */
public final class SingleNumericFieldPanel extends AbstractFieldPanel {
     ...
     */
    public SingleNumericFieldPanel() {
        setLayout(new BoxLayout(this, BoxLayout.LINE_AXIS));
        m_spinner = createSpinner();
        add(m_spinner);
    }
    ...
    public void init(final OperatorPanelParameters parameters) {
        ...
        NumericFieldUtil.initSpinner(m_spinner, columnSpec, values == null || values.length == 0 ? null : values[0]);
    }
    ...
    public String[] getValues() {
        return new String[]{m_spinner.getValue().toString()};
    }
    ...
    public void setValidationResult(final ValidationResult result) {
        setValidationResult(result, m_spinner, 0);
    }
