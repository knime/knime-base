...
/**
 * View object to show a group in the element tree.
 *
 * @author Viktor Buria
 */
public class TreeGroup extends TreeElement<Group> {

    /**
     * Constructs a {@link TreeGroup} object.
     *
     * @param group the {@link Group} object
     */
    public TreeGroup(final Group group) {
        super(group);
    }
