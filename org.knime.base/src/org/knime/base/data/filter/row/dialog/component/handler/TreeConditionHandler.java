...
/**
 * Possible actions handler for the {@link TreeCondition} object.
 *
 * @author Viktor Buria
 */
public class TreeConditionHandler extends TreeElementHandler<Condition, TreeCondition> {

    /**
     * Constructs a {@link TreeConditionHandler} object.
     *
     ...
     */
    public TreeConditionHandler(final DefaultMutableTreeNode treeNode, final TreePanelActions panelActions,
    ...
    public void updateView() {
        ...
        getPanelActions().validateAllTreeNodes();

        TreeNode node = getTreeNode();
        do {
            getPanelActions().updateElementView(node);
