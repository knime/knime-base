...
/**
 * Factory for the {@link StringFormatManagerNodeModel}
 *
 * @author Jasper Krauter, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("restriction")
public final class StringFormatManagerNodeFactory extends WebUINodeFactory<StringFormatManagerNodeModel> {
    ...
    private static final WebUINodeConfiguration CONFIG = WebUINodeConfiguration.builder()//
        ...
        .shortDescription("""
                ...
                """)//
        .fullDescription("""
                This node attaches formatting information to strings in a table.
                This does not change the data, only the way the strings in the
                selected columns are displayed in views, e.g., the Table View.
                """)//
        .modelSettingsClass(StringFormatManagerNodeSettings.class)//
     ...
     */
    public StringFormatManagerNodeFactory() {
        super(CONFIG);
    }

    @Override
    public StringFormatManagerNodeModel createNodeModel() {
        return new StringFormatManagerNodeModel(CONFIG);
    }
