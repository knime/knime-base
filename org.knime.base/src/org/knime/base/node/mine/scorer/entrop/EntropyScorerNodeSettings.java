...
final class EntropyScorerNodeSettings implements NodeParameters {
    ...
    static final String getFirstStringColumnAtPort(final NodeParametersInput ctx, final int portInd) {
