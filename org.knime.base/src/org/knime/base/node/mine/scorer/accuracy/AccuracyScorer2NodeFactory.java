...
public final class AccuracyScorer2NodeFactory extends NodeFactory<AccuracyScorer2NodeModel>
    ...
    private static final String SHORT_DESCRIPTION = """
            Compares two columns by their attribute value pairs.
            """;
    ...
    private static final List<PortDescription> OUTPUT_PORTS = List.of(
            fixedPort("Confusion matrix", """
                The confusion matrix.
                """),
            fixedPort("Accuracy statistics", """
                The accuracy statistics table.
                """)
    );
    private static final List<ViewDescription> VIEWS = List.of(
            new ViewDescription("Confusion Matrix", """
    ...
    public NodeDescription createNodeDescription() {
        return DefaultNodeDescriptionUtil.createNodeDescription(
            ...
            FULL_DESCRIPTION,
            List.of(),
            AccuracyScorer2NodeParameters.class,
            VIEWS,
            NodeType.Other,
            KEYWORDS,
            null
