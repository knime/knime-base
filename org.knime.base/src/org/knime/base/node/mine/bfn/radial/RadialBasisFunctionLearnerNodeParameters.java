...
final class RadialBasisFunctionLearnerNodeParameters extends BasisFunctionLearnerNodeParameters {
    ...
    @Widget(title = "Theta minus", description = """
            ...
            """)
    @NumberInputWidget(minValidation = IsNonNegativeValidation.class, maxValidation = ThetaMaximumValidation.class)
    ...
    static final class ThetaMaximumValidation extends MaxValidation {
