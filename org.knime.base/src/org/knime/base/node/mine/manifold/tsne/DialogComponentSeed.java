...
final class DialogComponentSeed extends DialogComponent {
    ...
    public DialogComponentSeed(
        ...
        m_drawNewButton.addActionListener(new ActionListener() {
           @Override
        ...
        m_enableLongCheckBox.addItemListener(new ItemListener() {
            @Override
        ...
        m_longField.addActionListener(new ActionListener() {
    ...
    protected final void updateComponent() {
        ...
        try {
            ...
            SettingsModelSeed model =
                    (SettingsModelSeed)getModel();
            m_longField.setValue((new Long(model.getLongValue())).toString());
            m_enableLongCheckBox.setSelected(model.getIsActive());
            checkEnableState();
        }
