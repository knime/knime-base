...
/**
 * Node parameters for PCA Inversion.
 *
...
class PCA2ReverseNodeParameters implements NodeParameters {
    ...
    @Widget(title = "Remove selected columns", description = """
    ...
    static final class ColumnSelectionPersistor extends LegacyColumnFilterPersistor {

        ColumnSelectionPersistor() {
            super(TransformationComputeSettings.USED_COLS_CFG);
        }

    }

    static class DoubleColumnsProvider extends CompatibleColumnsProvider {
