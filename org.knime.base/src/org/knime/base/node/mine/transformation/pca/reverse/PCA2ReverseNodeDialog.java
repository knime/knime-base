...
final class PCA2ReverseNodeDialog extends DefaultNodeSettingsPane {
    ...
    PCA2ReverseNodeDialog() {
        ...
        addDialogComponent(
            new DialogComponentColumnFilter2(computeSettings.getUsedColsModel(), PCA2ReverseNodeModel.DATA_IN_PORT));
        addDialogComponent(
            new DialogComponentBoolean(reverseSettings.getRemoveUsedColsModel(), "Remove selected columns"));
        addDialogComponent(new DialogComponentBoolean(computeSettings.getFailOnMissingsModel(),
