...
public class ClusterNodeModel2 extends WebUINodeModel<ClusterNodeSettings> {
    ...
    protected ClusterNodeModel2(final WebUINodeConfiguration configuration) {
        super(configuration, ClusterNodeSettings.class);
    }
    ...
    protected PortObject[] execute(final PortObject[] data, final ExecutionContext exec,
        final ClusterNodeSettings modelSettings) throws Exception {
        ...
        PMMLPortObjectSpec pmmlOutSpec = createPMMLSpec(modelSettings, inPMMLSpec, spec);
    ...
    private boolean updateClusterCenters(final ClusterNodeSettings modelSettings,
    ...
    private double[][] initializeClusters(final ClusterNodeSettings modelSettings,
    ...
    private static boolean isFirstRowsInitialized(final ClusterNodeSettings modelSettings) {
        return modelSettings.m_centroidInitialization == ClusterNodeSettings.CentroidInitialization.FIRST_ROWS;
    }

    private double[][] firstRowsClusterInitialization(final ClusterNodeSettings modelSettings,
    ...
    private double[][] randomClusterInitialization(final ClusterNodeSettings modelSettings,
    ...
    private Set<Long> randomCentroidsSetCreation(final ClusterNodeSettings modelSettings,
        final long nrOfRows) {
    ...
    private int findClosestPrototypeFor(final ClusterNodeSettings modelSettings, final DataRow row,
    ...
    protected PortObjectSpec[] configure(final PortObjectSpec[] inSpecs,
        final ClusterNodeSettings modelSettings) throws InvalidSettingsException {
        ...
        if (m_outputCenters) {
            ...
            return new PortObjectSpec[]{appendedSpec, createPMMLSpec(modelSettings, pmmlSpec, spec)};
        }
    }
    ...
    private static DataTableSpec createAppendedSpec(final ClusterNodeSettings modelSettings,
    ...
    private void addExcludeColumnsToIgnoreList(final ClusterNodeSettings modelSettings,
        final DataTableSpec originalSpec) {
    ...
    private static PMMLPortObjectSpec createPMMLSpec(final ClusterNodeSettings modelSettings,
     ...
     */
    public long getSeedOrRandom(final ClusterNodeSettings modelSettings) {
        if (modelSettings.m_useStaticRandomSeed) {
            return modelSettings.m_seedValue;
        }
