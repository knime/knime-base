...
public final class FeatureCycleFactories {
    ...
    public static FeatureCycleFactory createRoundRobinFeaturCycleFactory(final int numFeatures, final int maxCycles) {
        return () -> new RoundRobinFeatureCycleStrategy(numFeatures, maxCycles);
    }
