...
final class RoundRobinFeatureCycleStrategy implements FeatureCycle {
    ...
    private int m_currentCylce = 0;

    /**
     *
     */
    public RoundRobinFeatureCycleStrategy(final int numFeatures, final int maxCycles) {
    ...
    public boolean hasNext() {
        if (m_featureIdx == m_numFeatures - 1) {
            return m_changeInLastCycle && m_currentCylce < m_maxCycles - 1;
        } else {
