...
/**
 * Node parameters for MultiLayerPerceptron Predictor.
 *
...
@Modification(MLPPredictorNodeParameters.MLPPredictorNodeParametersModification.class)
final class MLPPredictorNodeParameters extends PredictorNodeParameters {

    static final class MLPPredictorNodeParametersModification implements Modification.Modifier {

        @Override
        public void modify(final Modification.WidgetGroupModifier group) {
            addDirtyTracker(group, MakeMLPPredictorDialogDirtyProvider.class);
        }
    ...
    @ValueProvider(MLPPredictionColumnDefaultProvider.class)
    ...
    @Persist(configKey = MLPPredictorNodeModel.CFGKEY_APPEND_PROBS)
    ...
    static class MLPPredictionColumnDefaultProvider extends PredictionColumnNameDefaultProvider {

        protected MLPPredictionColumnDefaultProvider() {
    ...
    static final class MakeMLPPredictorDialogDirtyProvider extends MakeDialogDirtyProvider {

        MakeMLPPredictorDialogDirtyProvider() {
