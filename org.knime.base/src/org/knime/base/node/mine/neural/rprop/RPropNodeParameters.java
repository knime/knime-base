...
class RPropNodeParameters implements NodeParameters {
    ...
    @Widget(title = "Number of hidden layers", description = """
            ...
            """)
    @NumberInputWidget(minValidation = IsPositiveIntegerValidation.class,
        maxValidation = Max100Validation.class)
    ...
    static final class Max100Validation extends MaxValidation {
    ...
    @Widget(title = "Use seed for random initialization", description = """
            If this checkbox is set, a seed can be set for initializing the weights and thresholds.
            """)
