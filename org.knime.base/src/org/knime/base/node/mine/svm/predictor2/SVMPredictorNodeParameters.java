...
@Modification(SVMPredictorNodeParameters.SVMPredictorNodeParametersModification.class)
final class SVMPredictorNodeParameters extends PredictorNodeParameters {

    static final class SVMPredictorNodeParametersModification implements Modification.Modifier {

        @Override
        public void modify(final Modification.WidgetGroupModifier group) {
            addDirtyTracker(group, MakeSVMPredictorDialogDirtyProvider.class);
        }
    ...
    static final class MakeSVMPredictorDialogDirtyProvider extends MakeDialogDirtyProvider {

        MakeSVMPredictorDialogDirtyProvider() {
