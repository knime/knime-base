 ...
 */
public final class ConstantValueColumnFilterNodeFactory2 extends DefaultNodeFactory {

    private static final DefaultNode NODE = DefaultNode.create() //
        .name("Constant Value Column Filter 2") //
        ...
        .ports(p -> p //
            ...
            .addOutputTable("Filtered Table", "Table with filtered columns.")) //
        .model(m -> m //
            .settingsClass(ConstantValueColumnFilterNodeSettings.class) //
            .configure(ConstantValueColumnFilterNodeFactory2::configure) //
            .execute(ConstantValueColumnFilterNodeFactory2::execute)); //

    /**
     * Default constructor for the node factory.
     */
    public ConstantValueColumnFilterNodeFactory2() {
        super(NODE);
    }
