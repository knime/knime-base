 ...
 */
public final class PatternWithCaseParameters extends PatternFilterParameters {

    PatternWithCaseParameters() {
        // for instantiation by framework
    }

    /**
     * Creates new parameters with the given pattern.
     *
     * @param pattern search pattern
     */
    public PatternWithCaseParameters(final String pattern) {
        m_pattern = pattern;
    }

    /** Case-sensitivity */
    @Widget(title = "Case matching", description = "Whether to consider casing when matching the pattern.")
    @ValueSwitchWidget
    @Layout(BeforePattern.class)
