...
public final class DefaultEqualityOperators {
    ...
    private abstract static class EqualBase implements FilterOperator<SingleStringParameters> {
        ...
        /**
         * Creates a new equality-based operator that matches when the equality comparison of the
         * {@link DataCell#equals(Object)} method returns the given value.
         *
         * @param matchTrue whether to match when equality comparison returns {@code true} or {@code false}
         */
        ...
        public Predicate<DataValue> createPredicate(final DataColumnSpec runtimeColumnSpec,
            ...
            FilterValidationUtil.checkSameType(this, type, configureDataType);
    ...
    @SuppressWarnings("restriction")
    // visible for testing
    static final class EqualDefault extends EqualBase implements EqualsOperator {
    ...
    // visible for testing
    /**
     * Implementation of the "not equal" operator that treats the result of comparing a value with a missing cell
     * ("unknown") as {@code true}, i.e. follows old KNIME Row Filter convention.
     */
    static final class NotEqualDefault extends EqualBase implements NotEqualsOperator {
    ...
    // visible for testing
    /**
     * Implementation of the "not equal nor missing" operator that treats the result of comparing a value with a missing
     * cell ("unknown") as {@code false}, i.e. follows SQL-style three-valued logic filter.
     */
    static final class NotEqualNorMissingDefault extends EqualBase implements NotEqualsNorMissingOperator {

        NotEqualNorMissingDefault() {
            super(false);
        }
