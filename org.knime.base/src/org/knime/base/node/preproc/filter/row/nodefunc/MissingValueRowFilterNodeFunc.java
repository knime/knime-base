...
/**
 * Filters rows by checking for missing values in a particular column.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
public final class MissingValueRowFilterNodeFunc extends AbstractAttributeRowFilterNodeFunc {

    @Override
    IRowFilter createFilter(final NodeSettingsRO arguments, final DataColumnSpec columnSpec, final boolean include)
        throws InvalidSettingsException {
        return new MissingValueRowFilter(columnSpec.getName(), include);
    }

    @Override
    String getName() {
        return "filter_rows_by_missing_value";
    }
