...
final class DefaultRegexPatternFilterOperator implements FilterOperator<PatternWithCaseParameters>, RegexOperator {

    private static final DefaultRegexPatternFilterOperator INSTANCE = new DefaultRegexPatternFilterOperator();

    private DefaultRegexPatternFilterOperator() {
        // for singleton
    }
     ...
     * @return the instance
     */
    static DefaultRegexPatternFilterOperator getInstance() {
        return INSTANCE;
    }
