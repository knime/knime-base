...
abstract class OrderingPredicateFactory extends AbstractPredicateFactory {
    ...
    protected final Ordering m_operator;

    private OrderingPredicateFactory(final FilterOperator operator) {
    ...
    static Optional<PredicateFactory> create(final DataType columnDataType, final FilterOperator operator) {
        ...
        if (preferredValueClass.equals(IntValue.class)) {
            factory = new OrderingIntPredicateFactory(operator);
        } else if (preferredValueClass.equals(LongValue.class)) {
            factory = new OrderingLongPredicateFactory(operator);
        } else if (preferredValueClass.equals(DoubleValue.class)) {
            factory = new OrderingDoublePredicateFactory(operator);
        } else {
            factory = new OrderingDataValuePredicateFactory(operator, columnDataType);
        }
    ...
    private static final class OrderingIntPredicateFactory extends OrderingPredicateFactory {
        ...
        private OrderingIntPredicateFactory(final FilterOperator operator) {
            super(operator);
        }
        ...
        public IndexedRowReadPredicate createPredicate(final int columnIndex, final DynamicValuesInput inputValues)
            ...
            if (refCell instanceof IntCell intCell) {
                ...
                final var predicate = IntOrderingPredicate.create(ref, m_operator);
        ...
        private IndexedRowReadPredicate comparingWithLongValue(final int intColumnIndex, final long ref) {
            ...
            final var predicate = LongOrderingPredicate.create(ref, m_operator);
        ...
        private IndexedRowReadPredicate comparingWithDoubleValue(final int intColumnIndex, final double reference) {
            ...
            final var predicate = DoubleOrderingPredicate.create(reference, m_operator);
            return (idx, rowRead) -> predicate.test(rowRead.<IntValue> getValue(intColumnIndex).getIntValue());
        }
    ...
    private static final class OrderingLongPredicateFactory extends OrderingPredicateFactory {
        ...
        private OrderingLongPredicateFactory(final FilterOperator operator) {
            super(operator);
        }
    ...
    private static final class OrderingDoublePredicateFactory extends OrderingPredicateFactory {
        ...
        private OrderingDoublePredicateFactory(final FilterOperator operator) {
            super(operator);
        }
        ...
        public IndexedRowReadPredicate createPredicate(final int columnIndex, final DynamicValuesInput inputValues)
            ...
            final var predicate = DoubleOrderingPredicate.create(ref, m_operator);
    ...
    private static final class OrderingDataValuePredicateFactory extends OrderingPredicateFactory {
        ...
        OrderingDataValuePredicateFactory(final FilterOperator operator, final DataType columnDataType) {
            super(operator);
