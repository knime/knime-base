...
abstract class OrderingPredicateFactory extends AbstractPredicateFactory {
    ...
    private enum Ordering {
        ...
        private static Optional<Ordering> fromOperator(final FilterOperator operator) {
    ...
    private static final class OrderingRowNumberPredicateFactory extends RowNumberPredicateFactory {

        private final Ordering m_ordering;

        private OrderingRowNumberPredicateFactory(final Ordering ordering) {
            m_ordering = ordering;
        }
