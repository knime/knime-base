...
abstract class PatternMatchingPredicateFactory extends AbstractPredicateFactory {
    ...
    private static final class NonColumn extends PatternMatchingPredicateFactory {
        ...
        NonColumn(final boolean isRegex, final IndexedRowReadFunction<String> toStringFn) {
            super(isRegex);
        ...
        public IndexedRowReadPredicate createPredicate(final OptionalInt columnIndex,
            ...
            CheckUtils.checkArgument(columnIndex.isEmpty(),
                "Pattern match on non-column did not expect any column index, but got one");
    ...
    static PredicateFactory forRowKey(final boolean isRegex) {
        return new NonColumn(isRegex, (idx, row) -> row.getRowKey().getString());
    }
    ...
    static PredicateFactory forRowNumber(final boolean isRegex) {
        ...
        return new NonColumn(isRegex, (idx, row) -> Long.toString(idx + 1));
    }
