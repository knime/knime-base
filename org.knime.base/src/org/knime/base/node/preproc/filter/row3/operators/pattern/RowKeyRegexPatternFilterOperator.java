...
/**
 * Filter operator for regex pattern matching on row keys.
 *
 * @author Paul Bärnreuther
 */
public final class RowKeyRegexPatternFilterOperator implements RowKeyFilterOperator<PatternWithCaseParameters> {
    ...
    @Override
    public Predicate<RowKeyValue> createPredicate(final PatternWithCaseParameters params)
