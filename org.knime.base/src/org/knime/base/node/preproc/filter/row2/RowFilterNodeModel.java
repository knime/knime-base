...
public class RowFilterNodeModel extends NodeModel {
    ...
    private final KnimeRowFilterConfig m_rowFilterConfig = new KnimeRowFilterConfig(CFGFILTER, GROUP_TYPES);
    ...
    private RowPredicate createRowPredicate(final DataTableSpec tableSpec) throws InvalidSettingsException {
    ...
    public StreamableOperator createStreamableOperator(final PartitionInfo partitionInfo,
        ...
        return new StreamableOperator() {
            ...
            public void runFinal(final PortInput[] inputs, final PortOutput[] outputs, final ExecutionContext ctx)
                ...
                final RowInput inData = in;
                final RowOutput output = out;
