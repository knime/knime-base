...
public final class RowNumberRegexPatternFilterOperator
    implements RowNumberFilterOperator<PatternFilterParameters>, RegexOperator {
    ...
    @Override
    public LongPredicate createPredicate(final PatternFilterParameters params, final long tableSize)
