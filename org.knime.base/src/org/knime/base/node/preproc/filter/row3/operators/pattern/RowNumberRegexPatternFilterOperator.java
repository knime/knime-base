...
/**
 * Filter operator for regex pattern matching on row numbers. Row numbers are converted to 1-based strings for pattern
 * matching.
 *
 * @author Paul Bärnreuther
 */
public final class RowNumberRegexPatternFilterOperator
    implements RowNumberFilterOperator<RowNumberPatternFilterParameters>, RegexOperator {
    ...
    @Override
    public LongPredicate createPredicate(final RowNumberPatternFilterParameters params, final long tableSize)
        throws InvalidSettingsException {
        final var stringPredicate = StringPredicate.pattern(params.m_pattern, true, false);
        return rowNumber -> stringPredicate.test(Long.toString(rowNumber));
    }

    @Override
    public Class<RowNumberPatternFilterParameters> getNodeParametersClass() {
