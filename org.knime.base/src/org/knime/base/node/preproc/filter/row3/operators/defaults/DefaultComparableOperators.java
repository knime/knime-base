...
public final class DefaultComparableOperators {
    ...
    // visible for testing
    static final class LessThanDefault extends ComparatorOperator implements LessThanOperator {
    ...
    // visible for testing
    static final class LessThanOrEqualDefault extends ComparatorOperator implements LessThanOrEqualOperator {
    ...
    // visible for testing
    static final class GreaterThanDefault extends ComparatorOperator implements GreaterThanOperator {
    ...
    // visible for testing
    static final class GreaterThanOrEqualDefault extends ComparatorOperator
