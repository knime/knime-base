...
public final class PredicateFactories {
    ...
    public static Optional<PredicateFactory> getRowNumberPredicateFactory(final FilterOperator operator) {
        return switch (operator) {
            case EQ:
                yield EqualityPredicateFactory.forRowNumber(true);
            case NEQ:
                yield EqualityPredicateFactory.forRowNumber(false);
            case GT:
                yield OrderingPredicateFactory.forRowNumber(FilterOperator.GT);
            case GTE:
                yield OrderingPredicateFactory.forRowNumber(FilterOperator.GTE);
            case LT:
                yield OrderingPredicateFactory.forRowNumber(FilterOperator.LT);
            case LTE:
                yield OrderingPredicateFactory.forRowNumber(FilterOperator.LTE);
            case REGEX:
            ...
            case IS_MISSING, IS_NOT_MISSING, FIRST_N_ROWS, LAST_N_ROWS, IS_TRUE, IS_FALSE:
                yield Optional.empty();
        };
    }
}
