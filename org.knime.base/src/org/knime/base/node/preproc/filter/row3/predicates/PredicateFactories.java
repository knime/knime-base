...
public final class PredicateFactories {
    ...
    public static Optional<PredicateFactory> getValuePredicateFactory(final FilterOperator operator,
        ...
        return switch (operator) {
            ...
            case GT:
                yield OrderingPredicateFactory.create(columnDataType, FilterOperator.GT);
            case GTE:
                yield OrderingPredicateFactory.create(columnDataType, FilterOperator.GTE);
            case LT:
                yield OrderingPredicateFactory.create(columnDataType, FilterOperator.LT);
            case LTE:
                yield OrderingPredicateFactory.create(columnDataType, FilterOperator.LTE);
            case IS_TRUE:
                yield BooleanPredicateFactory.create(columnDataType, true);
            case IS_FALSE:
                yield BooleanPredicateFactory.create(columnDataType, false);
            case REGEX:
                yield PatternMatchingPredicateFactory.forColumn(columnDataType, true);
            case WILDCARD:
                yield PatternMatchingPredicateFactory.forColumn(columnDataType, false);
