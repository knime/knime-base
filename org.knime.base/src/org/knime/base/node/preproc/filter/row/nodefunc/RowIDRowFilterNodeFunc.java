...
/**
 * NodeFunc that can be used by KAI to filter rows by matching the RowID with a regular expression.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
public class RowIDRowFilterNodeFunc extends AbstractRowFilterNodeFunc {
    ...
    void extendApi(final Builder builder) {
        builder
            ...
            .withBooleanArgument(CASE_SENSITIVE, "Whether the filter should be case sensitive.");//
    }

    @Override
    String getName() {
        return "filter_rows_by_id";
    }
    ...
    IRowFilter createFilter(final NodeSettingsRO arguments, final DataTableSpec tableSpec, final boolean include)
        ...
        return new RowIDRowFilter(regex, include, caseSensitive, false);
    }
