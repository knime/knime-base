...
/**
 * Validates the parameter of a numeric operator with a single numeric parameter.
 *
 * @author Perla Gjoka, KNIME GmbH, Konstanz, Germany
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
final class NumericOperandValidation extends SingleOperandValidation {
    ...
    public ValidationResult apply(final OperatorParameters parameters) {
        ...
        if(parameters.getColumnSpec().getRole() == ColumnRole.ROW_INDEX && Long.parseLong(values[0]) < 0) {
            result.addError(0, "Row index less than 0 not allowed");
        }
        return result;
    }
}
