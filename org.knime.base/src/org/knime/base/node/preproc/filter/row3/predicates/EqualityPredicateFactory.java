...
import org.knime.base.node.preproc.filter.row3.predicates.RowReadPredicateFactory.IntIntEquality;
...
public abstract class EqualityPredicateFactory extends AbstractPredicateFactory {
    ...
    private static final class EqualityDataCellPredicateFactory extends EqualityPredicateFactory {
        ...
        public IndexedRowReadPredicate createPredicate(final int columnIndex, final DynamicValuesInput inputValues)
            ...
            return IndexedRowReadPredicate.wrap( //
                m_matchEqual ? (rowRead -> rowRead.getValue(columnIndex).materializeDataCell().equals(refCell))
    ...
    private static final class EqualityIntPredicateFactory extends EqualityPredicateFactory {
        ...
        public IndexedRowReadPredicate createPredicate(final int columnIndex, final DynamicValuesInput inputValues)
            ...
            if (refCell instanceof IntCell intCell) {
                ...
                return IndexedRowReadPredicate.wrap(new IntIntEquality(m_matchEqual)
                        .createPredicate(rowRead -> rowRead.<IntValue>getValue(columnIndex), intCell));
            }
