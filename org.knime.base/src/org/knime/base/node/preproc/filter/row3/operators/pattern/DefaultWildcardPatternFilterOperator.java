...
final class DefaultWildcardPatternFilterOperator
    implements FilterOperator<PatternWithCaseParameters>, WildcardOperator {

    private static final DefaultWildcardPatternFilterOperator INSTANCE = new DefaultWildcardPatternFilterOperator();

    private DefaultWildcardPatternFilterOperator() {
        // for singleton
    }
     ...
     */
    public static DefaultWildcardPatternFilterOperator getInstance() {
        return INSTANCE;
    }
    ...
    @Override
    public Class<PatternWithCaseParameters> getNodeParametersClass() {
        return PatternWithCaseParameters.class;
    }
}
