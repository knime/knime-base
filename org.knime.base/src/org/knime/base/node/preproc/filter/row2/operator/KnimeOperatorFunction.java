...
/**
 * Operator functions for the KNIME Row Filter node.
 *
 * @author Perla Gjoka, KNIME GmbH, Konstanz, Germany
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
public interface KnimeOperatorFunction extends OperatorFunction<OperatorParameters, RowPredicateFactory> {
    // marker interface
}
