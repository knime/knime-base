        ...
        public Predicate<DataValue> createPredicate(final DataColumnSpec runtimeColumnSpec,
            ...
            if (!type.isCompatible(BooleanValue.class)) {
                throw FilterValidationUtil.createInvalidSettingsException(builder -> builder
                    .withSummary(FilterValidationUtil.getUnsupportedOperatorSummary(BooleanCell.TYPE, this,
                        runtimeColumnSpec))
                    .addResolutions(FilterValidationUtil.resolutionChangeInput(BooleanCell.TYPE)));
            }
