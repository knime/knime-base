...
abstract sealed class NominalValueRowCommonSettings implements DefaultNodeSettings {
    ...
    static final class NominalValueRowSplitterNodeSettings extends NominalValueRowCommonSettings {
        ...
        static final class NominalValueSelectionWidgetModifier implements WidgetGroup.Modifier {
            ...
            public void modify(final WidgetGroupModifier group) {
                ...
                group.find(NominalValueSelectionWidgetReference.class) //
                    ...
                    .withProperty("includedLabel", "First/upper table") //
                    .withProperty("excludedLabel", "Second/lower table") //
                    .modify();
            }
        }
        ...
        enum MissingValueHandling {
                ...
                @Label(value = "Exclude", description = """
                        Missing values are excluded from the first output table. \
                        They will be included in the second table instead.
                        """)
                EXCLUDE, //
                @Label(value = "Include", description = "Missing values are included in the first output table.")
                INCLUDE; //
    ...
    static final class SettingsUtils {
        ...
        static final String DESC_VALUES_SPLITTER = """
                Select the nominal values to be in the first output table, by moving them from left \
                (first/upper table) to right (second/lower table).
                """;
