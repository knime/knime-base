 ...
 * @since 4.1
 */
public abstract class AbstractCorrelationCompute2NodeView<M extends NodeModel> extends NodeView<M> {
    ...
    /**
     * Inits the GUI. Delegates to super class.
     *
     * @param nodeModel the correlation compute node model
     */
    protected AbstractCorrelationCompute2NodeView(final M nodeModel) {
        super(nodeModel);
    ...
    private JMenu getJMenu() {
        ...
        colWidthItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                int r = JOptionPane.showConfirmDialog(m_tableView, s, "Cell Size", JOptionPane.OK_CANCEL_OPTION,
    ...
    private static class MyTableContentView extends TableContentView {
        ...
        @Override
        protected DataValueRendererFamily getRendererFamily(final DataColumnSpec colSpec) {
        ...
        public Component prepareRenderer(final TableCellRenderer renderer, final int row, final int column) {
            ...
            if (val instanceof DoubleValue) {
                ...
                if (jresult != null) {
                    ...
                    jresult.setToolTipText(dS + " (" + rowName + " - " + colName + ")");
                }
            } else {
                if (jresult != null) {
    ...
    private static class ColorRender extends DoubleGrayValueRenderer {
        ...
        @Override
        protected Color setDoubleValue(final double val, final double min, final double max) {
            if (max == min) {
                return Color.WHITE;
            }
            if (Double.isNaN(val)) {
    ...
    private static class VerticalLabelUI extends BasicLabelUI {
        ...
        protected String layoutCL(final JLabel label, final FontMetrics fontMetrics, final String text, final Icon icon,
            ...
            Rectangle viewRC = new Rectangle(viewR.y, viewR.x, viewR.height, viewR.width);
            Rectangle iconRC = iconR;
            Rectangle textRC = textR;
            return super.layoutCL(label, fontMetrics, text, icon, viewRC, iconRC, textRC);
        }
    ...
    private static class LegendCorner extends ColorRender {
        ...
        static {
            DataColumnSpecCreator c = new DataColumnSpecCreator("ignored", DoubleCell.TYPE);
    ...
    private static class LegendCornerAll extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected,
            ...
            m_delegate.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column);
