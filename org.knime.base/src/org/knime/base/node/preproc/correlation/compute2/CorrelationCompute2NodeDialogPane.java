...
final class CorrelationCompute2NodeDialogPane extends DefaultNodeSettingsPane {
    ...
    CorrelationCompute2NodeDialogPane() {
        SettingsModelColumnFilter2 fS = CorrelationCompute2NodeModel.createColumnFilterModel();
        DialogComponentColumnFilter2 cF = new DialogComponentColumnFilter2(fS, 0);
        addDialogComponent(cF);

        SettingsModelIntegerBounded sI = CorrelationCompute2NodeModel.createNewPossValueCounterModel();
        DialogComponentNumberEdit cI = new DialogComponentNumberEdit(sI, "Possible Values Count");
