...
/**
 * Node parameters for Category to Number (Apply).
 *
 * @author Magnus Gohm, KNIME GmbH, Konstanz, Germany
 * @author AI Migration Pipeline v1.2
 */
@LoadDefaultsForAbsentFields
final class CategoryToNumberApplyNodeParameters implements NodeParameters {
    ...
    @Widget(title = "Append columns", description = """
            ...
            """)
    @Persist(configKey = CategoryToNumberApplyNodeSettings.APPEND_COLUMN)
    ...
    @Widget(title = "Column suffix", description = """
            ...
            """)
    @TextInputWidget(placeholder = " (to number)")
    @Persist(configKey = CategoryToNumberApplyNodeSettings.COLUMN_SUFFIX)
