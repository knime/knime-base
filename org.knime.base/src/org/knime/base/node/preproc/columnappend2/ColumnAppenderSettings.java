...
final class ColumnAppenderSettings implements DefaultNodeSettings {
    ...
    @Schema(title = "RowID mode", description = "Determines the RowIDs of the output table:"
            ...
            + "If one of the input table is longer than the other, missing values are inserted accordingly.</li> "//
            + "<li><b>Use the RowIDs from the selected input table</b>: "//
            + "The RowIDs of the table with the selected index are used. "//
            + "Tables with less number of rows will be filled with missing values accordingly. "//
            + "And tables with more number of rows will be truncated.</li>"//
            + "</ul>")
