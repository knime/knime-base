...
public class TableManipulatorNodeFactory extends ConfigurableNodeFactory<TableManipulatorNodeModel>
    ...
    @Override
    protected TableManipulatorNodeModel createNodeModel(final NodeCreationConfiguration creationConfig) {
        return new TableManipulatorNodeModel(getPortConfig(creationConfig));
    }
    ...
    @Override
    @SuppressWarnings("java:S5738") // required to create the legacy flow variable node dialog
