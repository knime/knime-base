...
/**
 * Implementation of GenericDefaultMultiTableRead.
 *
 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
 */
final class MultiTableRead extends GenericDefaultMultiTableRead<Table, DataValue> {
     ...
     */
    MultiTableRead(final Collection<Table> paths,
