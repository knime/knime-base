...
public final class CellUpdaterNodeFactory extends WebUINodeFactory<CellUpdaterNodeModel> {
     ...
     * Build the node.
     */
    public CellUpdaterNodeFactory() {
        super(CONFIGURATION);
    }

    @Override
    public CellUpdaterNodeModel createNodeModel() {
        return new CellUpdaterNodeModel(CONFIGURATION);
    }
