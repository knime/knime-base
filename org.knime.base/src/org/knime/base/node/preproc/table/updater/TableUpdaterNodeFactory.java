...
/**
 * The factory of the Table Updater node.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("restriction")
public final class TableUpdaterNodeFactory extends WebUINodeFactory<TableUpdaterNodeModel> {
     ...
     * Constructor.
     */
    public TableUpdaterNodeFactory() {
        super(CONFIG);
    }

    @Override
    public TableUpdaterNodeModel createNodeModel() {
        return new TableUpdaterNodeModel(CONFIG);
    }
