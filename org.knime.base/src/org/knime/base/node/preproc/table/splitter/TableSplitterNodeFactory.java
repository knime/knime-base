...
/**
 * Factory of the Table Splitter node.
 *
...
public final class TableSplitterNodeFactory extends WebUINodeFactory<TableSplitterNodeModel> {
    ...
    private static final String DESCRIPTION =
        "The Table Splitter splits the input table at the row that matches a given condition. "
            + "The part of the table that occurred before the matching row is forwarded to the top output table. "
            + "The bottom output table contains the rest of the input table.";
    ...
    @Override
    public TableSplitterNodeModel createNodeModel() {
        return new TableSplitterNodeModel(CONFIG);
    }
}
