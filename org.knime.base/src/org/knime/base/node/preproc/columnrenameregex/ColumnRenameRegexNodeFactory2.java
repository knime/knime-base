...
/**
 * The factory for the Column Rename (Replace) node (formerly Column Rename (Regex)).
 *
 * @author David Hickey, TNG Technology Consulting GmbH
 * @since 5.5
 */
@SuppressWarnings("restriction")
public class ColumnRenameRegexNodeFactory2 extends WebUINodeFactory<ColumnRenameRegexNodeModel2> {

    /**
     * Constructor for the node factory.
     */
    public ColumnRenameRegexNodeFactory2() {
        super(CONFIGURATION);
    }

    @Override
    public ColumnRenameRegexNodeModel2 createNodeModel() {
        return new ColumnRenameRegexNodeModel2(CONFIGURATION);
    }

    static final WebUINodeConfiguration CONFIGURATION = WebUINodeConfiguration.builder() //
        .name("Column Rename Replace") //
        ...
        .fullDescription("""
                ...
                """) //
        .modelSettingsClass(ColumnRenameRegexNodeSettings.class) //
        .keywords("regex", "rename", "column") //
