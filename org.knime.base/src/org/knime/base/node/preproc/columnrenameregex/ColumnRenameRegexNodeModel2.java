...
/**
 * Model for the Column Rename (Replace) node (formerly Column Rename (Regex)).
 *
 * @author David Hickey, TNG Technology Consulting GmbH
 */
@SuppressWarnings("restriction")
final class ColumnRenameRegexNodeModel2 extends WebUINodeModel<ColumnRenameRegexNodeSettings> {
     ...
     */
    public ColumnRenameRegexNodeModel2(final WebUINodeConfiguration config) {
        super(config, ColumnRenameRegexNodeSettings.class);
    }

    @Override
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec,
        final ColumnRenameRegexNodeSettings modelSettings) throws Exception {
    ...
    protected DataTableSpec[] configure(final DataTableSpec[] inSpecs,
        final ColumnRenameRegexNodeSettings modelSettings) throws InvalidSettingsException {

        return new DataTableSpec[]{createOutSpec(inSpecs[0], modelSettings)};
    }

    @Override
    protected void validateSettings(final ColumnRenameRegexNodeSettings settings) throws InvalidSettingsException {
        try {
     ...
     */
    private static Pattern createColumnRenamePattern(final ColumnRenameRegexNodeSettings settings)
    ...
    private DataTableSpec createOutSpec(final DataTableSpec inSpec, final ColumnRenameRegexNodeSettings settings) {
