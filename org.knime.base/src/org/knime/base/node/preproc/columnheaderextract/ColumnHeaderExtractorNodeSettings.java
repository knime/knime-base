...
final class ColumnHeaderExtractorNodeSettings implements DefaultNodeSettings {
    ...
    @Schema(title = "Replace column names",
        description = "If selected replaces the column names with new generated names. "//
            + "The names are generated by combining the prefix (provided below) with the column number. "//
            + "Otherwise the original column names will be used in the output tables.")
