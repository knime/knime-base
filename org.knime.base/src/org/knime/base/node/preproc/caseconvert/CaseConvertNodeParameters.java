...
/**
 * Settings for the Case Converter node using DefaultNodeSettings.
 *
...
final class CaseConvertNodeParameters implements NodeParameters {
    ...
    @Widget(title = "Case mode",
            description = "Choose if you want to convert to uppercase or lowercase.")
    ...
    private static final class ModePersistor implements NodeParametersPersistor<Mode> {
        ...
        public Mode load(final NodeSettingsRO settings) throws InvalidSettingsException {
            Boolean mode = settings.getBoolean(CaseConvertNodeModel.CFG_UPPERCASE);
            if (mode) {
        ...
        public void save(final Mode obj, final NodeSettingsWO settings) {
            ...
            settings.addBoolean(CaseConvertNodeModel.CFG_UPPERCASE, obj.equals(Mode.UPPERCASE));
        }
