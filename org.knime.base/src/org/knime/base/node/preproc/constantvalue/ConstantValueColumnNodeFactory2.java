...
public class ConstantValueColumnNodeFactory2 extends WebUINodeFactory<ConstantValueColumnNodeModel2> {
    ...
    static final WebUINodeConfiguration CONFIGURATION = WebUINodeConfiguration.builder() //
        ...
        .fullDescription("""
                This node adds or replaces columns containing a single constant value \
                in each row.
                """) //
        .modelSettingsClass(ConstantValueColumnNodeSettings.class) //
        .addInputTable("Input table", "The input table.") //
        .addOutputTable("Output table", "The input table with added/replaced columns containing constant values.") //
        .keywords() //
        .build();
