...
public class TopKSelectorNodeFactory2 extends WebUINodeFactory<TopKSelectorNodeModel2> {

    /**
     *
     */
    public TopKSelectorNodeFactory2() {
        super(CONFIGURATION);
    }

    @Override
    public TopKSelectorNodeModel2 createNodeModel() {
        return new TopKSelectorNodeModel2(CONFIGURATION);
    }

    private static final WebUINodeConfiguration CONFIGURATION = WebUINodeConfiguration.builder() //
        .name("Top k Row Filter (Labs)") //
