...
/**
 * NodeFactory of the ColumnRenamer node.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("restriction")
public final class ColumnRenamerNodeFactory extends WebUINodeFactory<ColumnRenamerNodeModel> {
     ...
     * Constructor.
     */
    public ColumnRenamerNodeFactory() {
        super(CONFIG);
    }


    @Override
    public ColumnRenamerNodeModel createNodeModel() {
        return new ColumnRenamerNodeModel(CONFIG);
    }
