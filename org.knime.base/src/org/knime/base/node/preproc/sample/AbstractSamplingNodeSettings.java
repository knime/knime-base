...
public abstract class AbstractSamplingNodeSettings implements DefaultNodeSettings {
    ...
    /**
     * Determines the class column from the data column if possible.
     *
     * @param spec to get the column name from
     */
    protected AbstractSamplingNodeSettings(final DataColumnSpec spec) {
        this.m_classColumn = spec != null ? spec.getName() : null;
    }
    ...
    @Widget(title = "Sampling strategy", description = """
            Determines how rows are selected for the output. Strategies include random, linear, stratified, \
    ...
    public boolean m_useFixedRandomSeed;
    ...
    public long m_seed = 1678807467440L;
            ...
            if (value == null) {
                ...
                return switch (value) {
                    ...
                    default -> throw new InvalidSettingsException(
                        String.format("Unknown sampling strategy: %s", value));
                };
            }
