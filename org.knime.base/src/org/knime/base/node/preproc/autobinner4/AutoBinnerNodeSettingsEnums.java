...
/**
 * Enums used in the settings for this node.
 *
...
final class AutoBinnerNodeSettingsEnums {
    ...
    enum BinBoundaryExactMatchBehaviourProxy {
    ...
    static final class NumberFormatSettingsGroupProxy implements DefaultNodeSettings {
        ...
        @Widget(title = "Number format", description = """
                ...
                """)
        @ValueSwitchWidget
        NumberFormatProxy m_numberFormat = NumberFormatProxy.STANDARD_STRING;
        ...
        @Widget(title = "Precision mode", description = """
                ...
                """)
        @ValueSwitchWidget
        PrecisionModeProxy m_precisionMode = PrecisionModeProxy.DECIMAL_PLACES;

        @Widget(title = "Rounding mode", description = """
                The rounding mode to use when rounding numbers \
                in the bins.
                """)
        RoundingDirectionProxy m_roundingMode = RoundingDirectionProxy.HALF_UP;

        NumberFormatSettingsGroup toBaseValue() {
