...
final class AutoBinnerNodeSettingsEnums {
    ...
    public enum BinNamingProxy {
        ...
        public final AutoBinningSettings.BinNaming m_binName;

        BinNamingProxy(final AutoBinningSettings.BinNaming binNaming) {
            m_binName = binNaming;
        }
    }

    public enum BinningTypeProxy {
        ...
        public final AutoBinningSettings.BinningType baseValue;

        BinningTypeProxy(final AutoBinningSettings.BinningType value) {
            this.baseValue = value;
        }
    }

    public enum RoundingDirectionProxy {
        ...
        public final AutoBinningSettings.NumberFormatSettingsGroup.RoundingDirection baseValue;

        RoundingDirectionProxy(final AutoBinningSettings.NumberFormatSettingsGroup.RoundingDirection value) {
            this.baseValue = value;
        }
    }

    public enum PrecisionModeProxy {
        ...
        public final AutoBinningSettings.NumberFormatSettingsGroup.PrecisionMode baseValue;

        PrecisionModeProxy(final AutoBinningSettings.NumberFormatSettingsGroup.PrecisionMode value) {
            this.baseValue = value;
        }
    }

    public enum NumberFormatProxy {
        ...
        public final AutoBinningSettings.NumberFormatSettingsGroup.NumberFormat m_baseValue;

        NumberFormatProxy(final AutoBinningSettings.NumberFormatSettingsGroup.NumberFormat value) {
            m_baseValue = value;
        }
    }

    public enum BinBoundaryExactMatchBehaviourProxy {
        ...
        public final AutoBinningSettings.BinBoundaryExactMatchBehaviour m_baseValue;

        BinBoundaryExactMatchBehaviourProxy(final AutoBinningSettings.BinBoundaryExactMatchBehaviour value) {
            m_baseValue = value;
        }
    }

    public static final class NumberFormatSettingsGroupProxy implements DefaultNodeSettings {
        ...
        @Widget(title = "Number format", description = """
                ...
                """)
        @ValueSwitchWidget
        public NumberFormatProxy m_numberFormat = NumberFormatProxy.STANDARD_STRING;
        ...
        @Widget(title = "Precision mode", description = """
                ...
                """)
        @ValueSwitchWidget
        public PrecisionModeProxy m_precisionMode = PrecisionModeProxy.DECIMAL_PLACES;

        @Widget(title = "Rounding mode", description = """
                The rounding mode to use when rounding numbers \
                in the bins.
                """)
        public RoundingDirectionProxy m_roundingMode = RoundingDirectionProxy.HALF_UP;

        public NumberFormatSettingsGroup toBaseValue() {
            var output = new AutoBinningSettings.NumberFormatSettingsGroup();
            output.m_numberFormat = m_numberFormat.m_baseValue;
            output.m_precision = m_precision;
            output.m_precisionMode = m_precisionMode.baseValue;
            output.m_roundingMode = m_roundingMode.baseValue;
