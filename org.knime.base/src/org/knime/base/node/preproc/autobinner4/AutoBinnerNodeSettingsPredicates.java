...
final class AutoBinnerNodeSettingsPredicates {
    ...
    static final class ShouldShowFixedBoundCheckboxes implements PredicateProvider {
        @Override
        public Predicate init(final PredicateInitializer i) {
            return i //
                .getEnum(BinningTypeRef.class) //
    ...
    static final class ShouldShowFixedUpperBoundField implements PredicateProvider {
        @Override
        public Predicate init(final PredicateInitializer i) {
            return i //
                .getPredicate(ShouldShowFixedBoundCheckboxes.class) //
                .and(i.getBoolean(FixUpperBoundRef.class).isTrue());
        }
    }

    static final class ShouldShowFixedLowerBoundField implements PredicateProvider {
        @Override
        public Predicate init(final PredicateInitializer i) {
            return i //
                .getPredicate(ShouldShowFixedBoundCheckboxes.class) //
    ...
    static final class ShouldDisplayCustomNumberFormatSettings implements PredicateProvider {
        @Override
        public Predicate init(final PredicateInitializer i) {
            return i //
