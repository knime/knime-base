...
import org.knime.base.node.preproc.autobinner4.AutoBinnerNodeSettingsPredicates.ShouldShowFixedBoundCheckboxes;
...
final class AutoBinnerNodeSettings implements DefaultNodeSettings {
    ...
    @Widget(title = "Fix lower bound", description = """
            ...
            """)
    @Effect(predicate = ShouldShowFixedBoundCheckboxes.class, type = EffectType.SHOW)
    ...
    enum NumberFormat {
        ...
        static final class Ref implements Reference<NumberFormat> {
        }
