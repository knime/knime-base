...
final class AutoBinnerNodeSettings implements DefaultNodeSettings {
    ...
    @NumberInputWidget(validation = NumberOfBinsValidation.class)
    ...
    @NumberInputWidget(validation = NumberGreaterThanZeroValidation.class)
    @Effect(predicate = BinningTypeIsCustomCutoffs.class, type = EffectType.SHOW)
    int m_cutoffForCustomCutoffs = 0;
    ...
    double m_cutoffForCustomQuantiles = 0;
