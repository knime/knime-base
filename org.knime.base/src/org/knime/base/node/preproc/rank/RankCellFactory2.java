 ...
 */
final class RankCellFactory2 extends SingleCellFactory {
    ...
    private final HashMap<DataCellTuple2, RankAssigner> m_groupHashTable;

    public RankCellFactory2(final DataColumnSpec newColSpec, final int[] groupColIndices, final int[] rankColIndices,
    ...
    public DataCell getCell(final DataRow row) {
        var rowVals = new DataCellTuple2(row, m_groupColIndices);
        var rankAssigner =
