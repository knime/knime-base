...
/**
 * Node parameters for Number to String (PMML).
 *
...
final class NumberToString3NodeParameters implements NodeParameters {
    ...
    static final class ColumnFilterPersistor extends LegacyColumnFilterPersistor {
        ...
        ColumnFilterPersistor() {
            super(AbstractNumberToStringNodeModel.CFG_INCLUDED_COLUMNS);
        }
