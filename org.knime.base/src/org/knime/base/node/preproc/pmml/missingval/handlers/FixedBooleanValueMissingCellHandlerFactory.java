...
/**
 * This class creates a factory for handling missing booleans with a fixed boolean value.
 *
 * @author Perla Gjoka, KNIME GmbH, Konstanz, Germany
 * @since 4.2
 */
public final class FixedBooleanValueMissingCellHandlerFactory extends MissingCellHandlerFactory {
    ...
    public Class<? extends MissingValueTreatmentParameters> getParametersClass() {
        return FixedBooleanValueParameters.class;
    }
    ...
    public MissingValueHandlerPanel getSettingsPanel() {
        return new FixedBooleanValuePanel();
    }
    ...
    public MissingCellHandler createHandler(final DataColumnSpec column) {
        return new FixedBooleanValueMissingCellHandler(column);
    }
