...
/**
 * This interface provides methods for loading and saving the node settings. It extends DynamicItemContext.
 *
 * @author Timmo Waller-Ehrat, KNIME GmbH, Konstanz, Germany
 * @param <T> DynamicPanelItem
 * @since 4.2
 */
interface RestorableDynamicItemContext<T extends DynamicPanelItem> extends DynamicItemContext<T> {
     ...
     */
    void load(NodeSettingsRO settings, final PortObjectSpec[] specs) throws NotConfigurableException;
     ...
     */
    void save(NodeSettingsWO settings) throws InvalidSettingsException;
