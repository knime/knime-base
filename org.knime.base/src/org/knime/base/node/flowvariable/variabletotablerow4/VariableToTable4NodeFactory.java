 ...
 */
public class VariableToTable4NodeFactory extends NodeFactory<VariableToTable4NodeModel> {
    ...
    public VariableToTable4NodeModel createNodeModel() {
        return new VariableToTable4NodeModel();
    }

    @Override
    public NodeView<VariableToTable4NodeModel> createNodeView(final int index, final VariableToTable4NodeModel model) {
        return null;
    }
