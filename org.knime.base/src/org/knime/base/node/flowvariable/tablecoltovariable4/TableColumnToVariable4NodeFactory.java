 ...
 */
public final class TableColumnToVariable4NodeFactory extends NodeFactory<TableColumnToVariable4NodeModel> {
    ...
    @Override
    public NodeView<TableColumnToVariable4NodeModel> createNodeView(final int viewIndex,
        final TableColumnToVariable4NodeModel nodeModel) {
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new TableColumnToVariable4NodeDialog();
    }
}
