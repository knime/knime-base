...
public class TableColumnToVariable4NodeModel extends WebUINodeModel<TableColumnToVariable4NodeSettings> {
    ...
    protected PortObjectSpec[] configure(final PortObjectSpec[] inSpecs,
        ...
        if (modelSettings.m_column == null || modelSettings.m_column.isEmpty()) {
