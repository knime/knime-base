 ...
 */
final class TableColumnToVariable4NodeDialog extends NodeDialogPane {
     ...
     * Constructor.
     */
    TableColumnToVariable4NodeDialog() {
        ...
        m_colSelection = new DialogComponentColumnNameSelection(TableColumnToVariable4NodeModel.createColumnSettings(),
            "Column name", 0, true, filter);
        m_colSelection.setToolTipText("Select the column whose rows must be converted to flow variables.");
        m_ignoreMissings =
            new DialogComponentBoolean(TableColumnToVariable4NodeModel.createIgnoreMissing(), "Skip missing values");
        m_ignoreMissings
