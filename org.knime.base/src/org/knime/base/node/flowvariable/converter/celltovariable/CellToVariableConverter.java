 ...
 * @param <T> the {@link VariableType} of the {@link FlowVariable} resulting from the conversion.
 */
public interface CellToVariableConverter<T extends VariableType<?>> {
     ...
     * @return the resulting {@link FlowVariable}
     */
    FlowVariable createFlowVariable(final String varName, final DataCell cell);
