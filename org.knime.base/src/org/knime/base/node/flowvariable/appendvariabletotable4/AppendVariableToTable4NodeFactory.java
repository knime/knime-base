...
public final class AppendVariableToTable4NodeFactory extends NodeFactory<AppendVariableToTable4NodeModel> {
    ...
    @Override
    protected AppendVariableToTable4NodeDialog createNodeDialogPane() {
        return new AppendVariableToTable4NodeDialog();
    }

    @Override
    public AppendVariableToTable4NodeModel createNodeModel() {
        return new AppendVariableToTable4NodeModel();
    }

    @Override
    public NodeView<AppendVariableToTable4NodeModel> createNodeView(final int index,
        final AppendVariableToTable4NodeModel model) {
        return null;
    }
