...
public class AppendVariableToTable4NodeFactory2 extends WebUINodeFactory<AppendVariableToTable4NodeModel2> {

    /**
    *
    */
    public AppendVariableToTable4NodeFactory2() {
        super(CONFIGURATION);
    }

    @Override
    public AppendVariableToTable4NodeModel2 createNodeModel() {
        return new AppendVariableToTable4NodeModel2(CONFIGURATION);
    }

    private static final WebUINodeConfiguration CONFIGURATION = WebUINodeConfiguration.builder() //
        .name("Variable to Table Column (Labs)") //
