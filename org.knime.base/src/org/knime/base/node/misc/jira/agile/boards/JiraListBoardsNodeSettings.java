...
public final class JiraListBoardsNodeSettings implements NodeParameters {
    @Section(title = "Jira Server") interface ServerSection {}
    @Section(title = "Filter") @After(ServerSection.class) interface FilterSection {}
    ...
    @Widget(title = "Type (optional)", description = "Board type filter: scrum or kanban") @TextInputWidget(placeholder = "scrum or kanban") @Layout(FilterSection.class) @Persist(configKey = "filter/type") public String m_type = "";
    @Widget(title = "Project Key (optional)", description = "Project key to filter boards") @TextInputWidget @Layout(FilterSection.class) @Persist(configKey = "filter/project") public String m_project = "";
}
