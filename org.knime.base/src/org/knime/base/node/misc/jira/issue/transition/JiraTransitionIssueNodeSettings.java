...
public final class JiraTransitionIssueNodeSettings implements NodeParameters {
    @Section(title = "Jira Server") interface ServerSection {}
    @Section(title = "Transition") @After(ServerSection.class) interface TransitionSection {}
    ...
    @Widget(title = "Issue Key", description = "Issue key, e.g. PROJ-123") @TextInputWidget(placeholder = "PROJ-123") @Layout(TransitionSection.class) @Persist(configKey = "issue/key") public String m_key = "";
    @Widget(title = "Transition Name", description = "Workflow transition name, e.g. Done") @TextInputWidget(placeholder = "Done") @Layout(TransitionSection.class) @Persist(configKey = "issue/transition") public String m_transition = "";
}
