...
public final class JiraDeleteIssueNodeSettings implements NodeParameters {
    @Section(title = "Jira Server") interface ServerSection {}
    @Section(title = "Delete") @After(ServerSection.class) interface DeleteSection {}
    ...
    @Widget(title = "Issue Key", description = "Issue key, e.g. PROJ-123") @TextInputWidget(placeholder = "PROJ-123") @Layout(DeleteSection.class) @Persist(configKey = "issue/key") public String m_key = "";
}
