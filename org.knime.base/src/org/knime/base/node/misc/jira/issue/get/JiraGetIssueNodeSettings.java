...
public final class JiraGetIssueNodeSettings implements NodeParameters {
    @Section(title = "Jira Server") interface ServerSection {}
    @Section(title = "Issue") @After(ServerSection.class) interface IssueSection {}
    ...
    @Widget(title = "Issue Key", description = "Issue key, e.g. PROJ-123") @TextInputWidget(placeholder = "PROJ-123") @Layout(IssueSection.class) @Persist(configKey = "issue/key") public String m_key = "";
}
