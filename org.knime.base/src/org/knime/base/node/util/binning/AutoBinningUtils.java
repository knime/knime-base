...
public class AutoBinningUtils {
    ...
    public static class AutoBinner {
         ...
         */
        private static BufferedDataTable extractAndSortSingleColumn(final BufferedDataTable data,
        ...
        private Map<String, List<Configuration.Bin>> createBins(final Map<String, List<BinBoundary>> edgesMap)
            throws InvalidSettingsException {
         ...
         * @param targetColumns the list of target columns to discretize
     ...
     */
    private static List<BinBoundary> createEdgesForEqualWidth(final DataColumnSpec singleColumnSpec,
        ...
        var unroundedEdges = DoubleStream.concat( //
            IntStream.range(0, numBins - 1).mapToDouble(i -> min + i / (double)numBins * (max - min)), //
            DoubleStream.of(max) //
        ).boxed().toList();
     ...
     */
    private static List<BinBoundary> createEdgesFromQuantiles(final BufferedDataTable sortedColumn,
     ...
     */
    private static List<BinBoundary> createEdgesForEqualCount( //
