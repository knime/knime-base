...
import org.knime.base.node.util.binning.AutoBinningUtils.BinBoundary;
...
public record AutoBinningSettings( //
    ...
    public sealed interface BinningSettings {
         ...
         */
        public static record FixedWidth(int numBins) implements BinningSettings {
            @Override
         ...
         * @param numBins the number of bins to create.
         */
        public static record FixedFrequency(int numBins) implements BinningSettings {
            @Override
            public BinningType binningType() {
         ...
         */
        public static record SampleQuantiles(BinBoundary[] quantiles) implements BinningSettings {
            @Override
            public BinningType binningType() {
     ...
     */
    public record DataBoundsSettings(BoundSetting upperBound, BoundSetting lowerBound) {
        ...
        public sealed interface BoundSetting {
             ...
             */
            public static record NoBound() implements BoundSetting {
                // no additional fields
            }
        }
    }
