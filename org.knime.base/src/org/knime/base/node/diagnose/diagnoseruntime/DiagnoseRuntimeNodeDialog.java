...
/**
 * Dialog for the new diagnose runtime node.
 *
 * @author Jasper Krauter, KNIME AG, Schloss
 * @author Leon Wenzler, KNIME AG, Schloss
 */
public class DiagnoseRuntimeNodeDialog extends DefaultNodeSettingsPane {

    // dialog labels
    static final String LABEL_ISSAVEFILE = "Save Heap Dump as File";

    /**
     * Create the node dialog
     */
    public DiagnoseRuntimeNodeDialog() {
        buildDialog();
    }
    ...
    private void buildDialog() {
        ...
        var checkbox = new DialogComponentBoolean(isSavedModel, LABEL_ISSAVEFILE);
        ...
        checkbox.getModel().addChangeListener(
            e -> fileChooser.getModel().setEnabled(((SettingsModelBoolean)e.getSource()).getBooleanValue()));
    }
}
