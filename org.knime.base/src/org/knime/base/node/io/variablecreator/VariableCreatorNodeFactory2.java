...
public class VariableCreatorNodeFactory2 extends WebUINodeFactory<VariableCreatorNodeModel> {

    /**
     *
     */
    public VariableCreatorNodeFactory2() {
        super(CONFIGURATION);
    }

    @Override
    public VariableCreatorNodeModel createNodeModel() {
        return new VariableCreatorNodeModel();
    }
        ...
        .fullDescription("""
                ...
                <p>
                    ...
                    <ul>
                        ...
                        <li>
                            <b>Double</b>:  floating point decimal number with possible values from around \
                            4.9&#183;10&#8315;&#179;&#178;&#8308; to 1.8&#183;10&#179;&#8304;&#8312; \
