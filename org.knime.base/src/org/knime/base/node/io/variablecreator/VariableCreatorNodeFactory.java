...
public final class VariableCreatorNodeFactory extends NodeFactory<VariableCreatorNodeModel> {
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new VariableCreatorNodeDialog();
    }
     ...
     */
    @Override
    public NodeView<VariableCreatorNodeModel> createNodeView(final int viewIndex,
        final VariableCreatorNodeModel nodeModel) {
        return null;
    }
