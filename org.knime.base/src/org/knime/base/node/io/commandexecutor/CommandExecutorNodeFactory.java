...
public class CommandExecutorNodeFactory extends NodeFactory<CommandExecutorNodeModel>
    ...
    public NodeView createNodeView(final int viewIndex,
            final CommandExecutorNodeModel nodeModel) {
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, CommandExecutorNodeSettings.class);
    }
    ...
    public KaiNodeInterface createKaiNodeInterface() {
        return new DefaultKaiNodeInterface(Map.of(SettingsType.MODEL, CommandExecutorNodeSettings.class));
    }
