...
import org.knime.base.node.io.filehandling.webui.reader2.TransformationParametersStateProvidersCommon.AbstractTransformationSettingsWidgetModification;
...
public final class TransformationParametersStateProviders {
    ...
    public abstract static class TransformationElementSettingsProvider<T>
        ...
        implements TransformationElementsMapper<T> {
        ...
        public TransformationElementSettings[] computeState(final NodeParametersInput context) {
            ...
            return toTransformationElements(suppliedSpecs == null ? List.of() : suppliedSpecs,
                m_howToCombineColumnsSup.get().toColumnFilterMode(), m_existingSettings.get(),
     ...
     * @param <T> the type used to represent external data [T]ypes
     */
    public abstract static class TypeChoicesProvider<T>
        implements StringChoicesProvider, TypedReaderTableSpecsProvider.Dependent<T>, TypeChoicesMapper<T> {
     ...
     * @param <T> the type used to represent external data [T]ypes
     */
    public abstract static class TransformationSettingsWidgetModification<T>
        extends AbstractTransformationSettingsWidgetModification<TableSpecSettingsWithFsLocation> {
