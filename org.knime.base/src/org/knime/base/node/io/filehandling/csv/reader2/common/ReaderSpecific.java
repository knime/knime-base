 ...
 * the same interface for multiple classes (e.g. in the {@link CommonReaderTransformationParametersPersistor} and for
 * classes in {@link CommonReaderTransformationParametersStateProviders}, extends these interfaces by ones that overwrite
...
public final class ReaderSpecific {
     ...
     */
    public interface ConfigAndReader<C extends ReaderSpecificConfig<C>, T, S extends AbstractMultiTableReadConfig<C, DefaultTableReadConfig<C>, T, S>> {
