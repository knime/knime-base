 ...
 */
final class ImageWriterTableNodeModel
    extends AbstractMultiTableWriterNodeModel<ImageWriterTableNodeConfig, ImageMultiTableCellFactory> {
    ...
    ImageWriterTableNodeModel(final PortsConfiguration portConfig, final ImageWriterTableNodeConfig nodeConfig,
        final int inputTableIndex) {
        super(portConfig, nodeConfig, inputTableIndex);
    }

    @Override
    protected ImageMultiTableCellFactory getFactory(final DataColumnSpec[] outputColumnSpecs,
        final int sourceColumnIndex, final FileOverwritePolicy overwritePolicy) {
        return new ImageMultiTableCellFactory(outputColumnSpecs, sourceColumnIndex, overwritePolicy);
    }
