...
/**
 * Parameters for the Table Reader Node.
 *
 * @author Paul Bärnreuther
 */
@Migration(KnimeTableReaderMigration.class)
class KnimeTableReaderNodeParameters implements NodeParameters {
    ...
    KnimeTableReaderNodeParameters(final NodeCreationConfiguration nodeCreationConfig) {
    ...
    KnimeTableReaderNodeParameters() {
        // default constructor
    }
