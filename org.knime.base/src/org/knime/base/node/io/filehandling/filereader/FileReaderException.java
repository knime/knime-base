 ...
 * {@link org.knime.base.node.io.filereader.FileRowIterator}) throws if something goes wrong.
 *
 * This is a runtime exception for now.
 *
 * @author Peter Ohl, University of Konstanz
 */
final class FileReaderException extends RuntimeException {
     ...
     */
    FileReaderException(final String msg, final DataRow faultyRow, final int lineNumber) {
        super(msg);
        m_row = faultyRow;
    ...
    /**
     * @return the row that was (possibly partially!) read before things went wrong. Could be <code>null</code>, if not
     *         set.
     */
    DataRow getErrorRow() {
        return m_row;
    ...
    /**
     * @return the line number where the error occurred in the file. Could be -1 if not set.
     */
