...
/**
 * File chooser settings model for the Create Paths node.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
final class SettingsModelCreatorFileChooser extends AbstractSettingsModelFileChooser<SettingsModelCreatorFileChooser> {
     ...
     * Copy constructor.
     *
     * @param toCopy the settings model to copy
     */
    private SettingsModelCreatorFileChooser(final SettingsModelCreatorFileChooser toCopy) {
        super(toCopy);
    }
    ...
    /**
     * Creates a {@link WritePathAccessor} for accessing the selected path.
     *
     * @return the {@link WritePathAccessor} for accessing the selected path
     */
    public WritePathAccessor createCreatorPathAccessor() {
        return super.createPathAccessor();
    }

    @Override
    protected String getModelTypeID() {
        return "SMID_CreatorFileChooser";
    }
