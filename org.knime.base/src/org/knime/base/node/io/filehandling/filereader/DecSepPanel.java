 ...
 */
final class DecSepPanel extends JPanel {
    ...
    private static Container getTextBox() {
        ...
        result.add(new JLabel("Enter new separators " + "(used for double columns only)."));
        result.add(Box.createVerticalStrut(20));
        result.add(new JLabel("The decimal separator is the floating" + " point character (required),"));
        result.add(new JLabel("the thousands separator groups" + " thousands and can be omitted."));
    ...
    boolean overrideSettings(final FileReaderNodeSettings settings) {
        ...
        boolean changed = (oldDecSep != newDecSep) || (oldThousSep != newThousSep);
