...
/**
 * Node parameters for PMML Reader.
 *
...
class PMMLReaderNodeParameters implements NodeParameters {

    static final class FileChooserPersistor extends LegacyReaderFileSelectionPersistor {
        FileChooserPersistor() {
            super("filechooser");
        }
    }

    @Widget(title = "Source", description = "The path to the file to select.")
    @Persistor(FileChooserPersistor.class)
    @Migrate
    @FileReaderWidget(fileExtensions = {"pmml"})
