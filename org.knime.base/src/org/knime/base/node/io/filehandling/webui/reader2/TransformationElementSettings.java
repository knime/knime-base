...
/**
 * Settings for a single column transformation within the table transformation array widget.
 *
...
public class TransformationElementSettings implements WidgetGroup, Persistable {
    ...
    /**
     * State provider that supplies the title of an array element, which is the original column name or "Any unknown
     * column" for the unknown columns placeholder.
     *
     * @noreference non-public API
     */
    ...
    /**
     * State provider that supplies the subtitle of an array element, which is the human-readable label of the
     * original/default column type.
     *
     * @noreference non-public API
     */
     ...
     * visible for testing classes in org.knime.base.node.io.filehandling.webui.testing
     *
     * @param columnName the name of the column, or {@code null} for the unknown columns placeholder
     * @param includeInOutput whether to include this column in the output
     * @param columnRename the new name for this column, or {@code null} if the name should not be changed
     * @param type the production path identifier for the target type or data type identifier for unknown columns
     * @param originalType the production path identifier for the original/default type
     * @param originalTypeLabel human-readable label for the original type
     */
     ...
     * visible for testing classes in org.knime.base.node.io.filehandling.webui.testing
     *
     * @return a new {@link TransformationElementSettings} representing the &lt;any unknown column&gt; placeholder
     */
    ...
    public static class Data {
        ...
        static boolean areSettingsMatching(Data[] data, TransformationElementSettings[] settings) {
        ...
        /**
         * Persistor that does not persist the {@link Data} settings, as they are only used for dirty tracking (UI-only)
         * and must not be saved to or loaded from the node settings.
         *
         * @noreference non-public API
         */
