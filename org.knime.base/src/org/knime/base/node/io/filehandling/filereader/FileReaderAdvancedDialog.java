 ...
 */
final class FileReaderAdvancedDialog extends JDialog {
     ...
     */
    FileReaderAdvancedDialog(final Frame parent, final FileReaderNodeSettings settings) {
        super(parent);
        m_settings = settings;
        m_closedViaOK = false;
        setModal(true);
     ...
     *
     * @param settings the settings to modify. Settings from the dialog will override settings in the passed object.
     */
    ...
    /**
     * Before the dialog closes it calls this method. The dialog disappears only if this method returns null. If it
     * returns an error message it stays open and displays the message.
     */
    ...
    private JPanel getJContentPane() {
        if (m_jContentPane == null) {
            ...
            m_jContentPane.setLayout(new BoxLayout(m_jContentPane, BoxLayout.Y_AXIS));
    ...
    private JPanel getControlPanel() {
        if (m_controlPanel == null) {
            ...
            m_controlPanel.setLayout(new BoxLayout(m_controlPanel, BoxLayout.X_AXIS));
    ...
    private JButton getOkButton() {
        if (m_okButton == null) {
            ...
            m_okButton.addActionListener(e -> {
                ...
                if (errMsg != null) {
                    JOptionPane.showMessageDialog(FileReaderAdvancedDialog.this, errMsg, "Invalid Settings",
    ...
    private JButton getCancelButton() {
        if (m_cancelButton == null) {
            ...
            m_cancelButton.addActionListener(e -> setVisible(false));
        }
    ...
    /**
     * After the dialog closes this will return <code>true</code> if the user okayed the dialog and settings should be
     * taken over.
     *
     * @return <code>true</code> if the dialog was closed through the OK button
     */
    boolean closedViaOk() {
    ...
    /**
     * @return true if one of the settings changed that needs a re-analyze of the file to become affective
     */
