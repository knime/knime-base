...
/**
 * <code>NodeFactory</code> for ARFF writer node.
 *
 * @author Dragan Keselj, KNIME GmbH
 */
public final class ARFFWriter2NodeFactory extends ConfigurableNodeFactory<ARFFWriter2NodeModel> {
    ...
    @Override
    protected ARFFWriter2NodeModel createNodeModel(final NodeCreationConfiguration creationConfig) {
        return new ARFFWriter2NodeModel(getPortsConfig(creationConfig));
    }

    @Override
    protected NodeDialogPane createNodeDialogPane(final NodeCreationConfiguration creationConfig) {
        return new ARFFWriter2NodeDialog(new ARFFWriter2Config(getPortsConfig(creationConfig)));
    }

    @Override
    public NodeView<ARFFWriter2NodeModel> createNodeView(final int viewIndex, final ARFFWriter2NodeModel nodeModel) {
        return null;
    }
