...
public final class CSVFormatParameters implements NodeParameters {
     ...
     */
    public enum RowDelimiterOption {
    ...
    @TextInputWidget(maxLengthValidation = HasAtMaxOneCharValidation.class)
    @Layout(CSVTableReaderLayoutAdditions.FileFormat.QuoteCharactersHorizontal.QuoteCharacter.class)
    ...
    @Widget(title = "Quote escape character", description = """
            ...
            """)
    @TextInputWidget(maxLengthValidation = HasAtMaxOneCharValidation.class)
    @Layout(CSVTableReaderLayoutAdditions.FileFormat.QuoteCharactersHorizontal.QuoteEscapeCharacter.class)
    ...
    @Layout(CSVTableReaderLayoutAdditions.Values.class)
