...
/**
 * Node parameters for Image Writer (Port).
 *
...
class ImagePortWriterNodeParameters implements NodeParameters {
        ...
        public void modify(final WidgetGroupModifier group) {
            ...
            fileSelection.modifyAnnotation(Widget.class)
                ...
                .withProperty("description", """
                    Select a file to store the output image. The image will be written in either PNG or SVG format \
                    depending on the file extension specified (.png or .svg).
                    """)
                .modify();

            restrictOverwritePolicyOptions(group, ImagePortWriterOverwritePolicyChoicesProvider.class);
        }
    }

    private static final class ImagePortWriterOverwritePolicyChoicesProvider
