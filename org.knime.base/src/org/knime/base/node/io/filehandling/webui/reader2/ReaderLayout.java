...
public interface ReaderLayout {
    ...
    interface File {
        /**
         * Layout container for the parameter selecting the file(s) to read.
         */
        interface Source {
        }
    }
    ...
    /**
     * For configuring column and data type detection.
     */
     ...
     */
    @Section(title = "Table Transformation", description = """
