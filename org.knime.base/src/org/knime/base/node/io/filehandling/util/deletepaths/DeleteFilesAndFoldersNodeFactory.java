...
public final class DeleteFilesAndFoldersNodeFactory extends ConfigurableNodeFactory<DeleteFilesAndFoldersNodeModel> {
    ...
    protected DeleteFilesAndFoldersNodeModel createNodeModel(final NodeCreationConfiguration creationConfig) {
        return new DeleteFilesAndFoldersNodeModel(creationConfig.getPortConfig().orElseThrow(IllegalStateException::new));
    }

    @Override
    protected NodeDialogPane createNodeDialogPane(final NodeCreationConfiguration creationConfig) {
        return new DeleteFilesAndFoldersNodeDialog(creationConfig.getPortConfig().orElseThrow(IllegalStateException::new));
    }
    ...
    @Override
    public NodeView<DeleteFilesAndFoldersNodeModel> createNodeView(final int viewIndex, final DeleteFilesAndFoldersNodeModel nodeModel) {
        return null;
    }
