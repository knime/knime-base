...
public final class CSVFormatProvider extends CSVFormatAutoDetector implements StateProvider<CsvFormat> {
    ...
    static final class SkipFirstLinesRef implements ValueRef<Long> {
    }

    static final class CharsetRef implements ValueRef<CSVTableReaderNodeSettings.Encoding.Charset> {
    }

    static final class BufferSizeRef implements ValueRef<Integer> {
    }

    static final class CommentStartRef implements ValueRef<String> {
    }

    static final class FileChooserRef implements ValueRef<FileChooser> {
    }

    static final class AutoDetectButtonRef implements ButtonRef {
    }
