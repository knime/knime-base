...
final class LineReaderConfig2 implements ReaderSpecificConfig<LineReaderConfig2> {
    ...
    private boolean m_replaceEmpty = false;
    ...
    private LineReaderConfig2(final LineReaderConfig2 toCopy) {
        ...
        setReplaceEmpty(toCopy.replaceEmpty());
    ...
    public void setReplaceEmpty(final boolean replaceEmpty) {
        m_replaceEmpty = replaceEmpty;
    }
}
