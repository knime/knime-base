...
/**
 * Abstract base class for saving a {@link ConfigID} derived from node parameters.
 *
...
public abstract class AbstractConfigIDSaver<P> implements ParametersSaver<P> {
    ...
    /**
     * Returns the source ID to be used for the given parameters. Is only stored if the returned value is not null.
     *
     * @param param the parameters
     * @return the source id
     */
    protected String getSourceID(P param) {
        return null;
    }
}
