...
/**
 * The NodeFactory for the "Create Paths" node.
 *
...
public final class CreatePathsNodeFactory extends ConfigurableNodeFactory<CreatePathsNodeModel> {
    ...
    @Override
    protected CreatePathsNodeModel createNodeModel(final NodeCreationConfiguration creationConfig) {
        return new CreatePathsNodeModel((creationConfig.getPortConfig().orElseThrow(IllegalStateException::new)));
    }

    @Override
    protected NodeDialogPane createNodeDialogPane(final NodeCreationConfiguration creationConfig) {
        return new CreatePathsNodeDialog(creationConfig.getPortConfig().orElseThrow(IllegalStateException::new));
    }

    @Override
    public NodeView<CreatePathsNodeModel> createNodeView(final int viewIndex, final CreatePathsNodeModel nodeModel) {
        return null;
    }
