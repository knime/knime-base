...
public abstract class CommonTableReaderNodeParameters implements NodeParameters {
    ...
    MultiTableReadParameters m_multiTableReadParameters = new MultiTableReadParameters();

    public void loadFromTableReaderPathSettings(final TableReaderPath path) {
        m_source = path.location;
    }

    public void saveToTableReaderPathSettings(final TableReaderPath path) {
        path.location = m_source;
    }

    public void loadFromConfig(final MultiTableReadConfig<?, ?> config) {
        m_multiTableReadParameters.loadFromConfig(config);
    }

    public void saveToConfig(final  AbstractMultiTableReadConfig<?, ? extends DefaultTableReadConfig<?>, ?, ?> config) {
        m_multiTableReadParameters.saveToConfig(config);
    }
