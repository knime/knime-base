 ...
 */
@Layout(LimitMemoryPerColumnLayout.class)
final class LimitMemoryPerColumnParameters implements NodeParameters {

    @After(MaximumNumberOfColumnsLayout.class)
    interface LimitMemoryPerColumnLayout {
    }
