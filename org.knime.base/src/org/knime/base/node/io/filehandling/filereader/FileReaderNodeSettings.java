 ...
 */
final class FileReaderNodeSettings extends FileReaderSettings {
    ...
    /**
     * Creates a new settings object for the file reader note and initializes it from the config object passed. If
     * <code>null</code> is passed default settings will be applied where applicable. The default setting are not valid
     * in the sense that they can't be used without modification.
     *
     * @param cfg a config object containing all settings or <code>null</code> to create default settings
     * @throws InvalidSettingsException if the settings in the config object are incomplete, inconsistent or in any
     *             other was invalid
     */
    FileReaderNodeSettings(final NodeSettingsRO cfg, final SettingsModelReaderFileChooser fileChooser)
        throws InvalidSettingsException {
        super(cfg, fileChooser);
        ...
        if (cfg != null) {
            ...
            m_delimsAtEOLUserValue = cfg.getBoolean(CFGKEY_EOLDELIMUSERVAL, ignoreEmptyTokensAtEndOfRow());
    ...
    FileReaderNodeSettings(final FileReaderNodeSettings clonee) {
        ...
        m_columnProperties = new Vector<ColProperty>(clonee.m_columnProperties.size());
        ...
        for (int i = 0; i < m_columnProperties.size(); i++) {
            if (clonee.m_columnProperties.get(i) != null) {
                m_columnProperties.set(i, (ColProperty)clonee.m_columnProperties.get(i).clone());
            }
        }
     ...
     */
    FileReaderNodeSettings(final SettingsModelReaderFileChooser fileChooser) {
        super(fileChooser);
        m_columnProperties = new Vector<ColProperty>();
    ...
    /**
     * Writes all settings into the passed configuration object. Except for the analyzedAllRows flag.
     *
     * {@inheritDoc}
     */
    @Override
        ...
        for (String key : cfg.keySet()) {
            ...
            try {
                ...
                throw new InvalidSettingsException(
                    "Keyword for column property" + " must be a integer number (got '" + key + "').");
            }
            if ((pos < 0) || (pos >= len)) {
                throw new InvalidSettingsException(
                    "Expecting column property" + " key between 0 and " + (len - 1) + " (got " + pos + ").");
            }
            if (m_columnProperties.get(pos) != null) {
                throw new InvalidSettingsException(
                    "Properties for column number " + pos + " are specified twice in the conf object.");
            }
     ...
     */
    void setColumnProperties(final Vector<? extends ColProperty> colProps) {
        if (colProps == null) {
    ...
    /**
     * @return a copy of the Vector storing {@link ColProperty} objects or <code>null</code> if not set
     */
    ...
    public String getMissingValueOfColumn(final int colIdx) {
        if ((m_columnProperties == null) || (colIdx >= m_columnProperties.size())) {
            return null;
        }
    ...
    public void setMissingValueForColumn(final int colIdx, final String pattern) {
        if ((m_columnProperties == null) || (colIdx >= m_columnProperties.size())) {
            throw new IllegalArgumentException("Can't set missing value" + " patterns for index '" + colIdx + "' yet.");
        }
    ...
    public void setFormatParameterForColumn(final int colIdx, final String format) {
        if ((m_columnProperties == null) || (colIdx >= m_columnProperties.size())) {
            throw new IllegalArgumentException("Can't set format parameter " + " for index '" + colIdx + "' yet.");
        }
        m_columnProperties.get(colIdx).setFormatParameter(format);
    }

    /**
     * Stores the number of columns set by the user. (Must not be the same as the number of column properties stored in
     * this object).
     *
     * @param numOfCols the number of columns to store
     */
    void setNumberOfColumns(final int numOfCols) {
    ...
    /**
     * Derives a DataTableSpec from the current settings. The spec will not contain any domain information. It will
     * contain only the columns to include in the table (excl. the columns to skip).
     *
     * @return a DataTableSpec corresponding to the current settings or <code>null</code> if the current settings are
     *         invalid
     *
     */
    ...
    DataTableSpec createDataTableSpec(final boolean checkFile) {
    ...
    /**
     * @return an array whose elements are set to true if the corresponding column should be skipped - not included in
     *         the table.
     */
    ...
    /**
     * Sets default settings in this object. See the submethods for details, but basically its: zero number of columns,
     * no column names and types, file has row headers and columns headers; One line per row, create empty rows for
     * empty lines, space or comma seperates columns, c-Style comments, double and single quotes (with escape char).
     * Call this only on an empty settings object.
     */
     ...
     */
    void setIgnoreEmptyLinesUserSet(final boolean s) {
        m_ignoreEmptyLinesIsSet = s;
    }

    /**
     * @return <code>true</code> if the value was set by the user, <code>false</code> if it's still at constructor's
     *         default value
     */
    ...
    /**
     * Set <code>true</code> to indicate that the flag is actually set and is not still the default value.
     *
     * @param s the new value of the flag
     */
    void setFileHasRowHeadersUserSet(final boolean s) {
        m_hasRowHeadersIsSet = s;
    }

    /**
     * @return <code>true</code> is the value was set, <code>false</code> if it's still at constructor's default value
     */
     ...
     * @param s the new value of the flag
     */
    void setFileHasColumnHeadersUserSet(final boolean s) {
     ...
     * @param s the new value of the flag
     */
    void setCommentUserSet(final boolean s) {
        m_commentIsSet = s;
    }

    /**
     * @return <code>true</code> is the value was set by the user, <code>false</code> if it's still at constructor's
     *         default value
     */
     ...
     * @param s the new value of the flag
     */
    void setDelimiterUserSet(final boolean s) {
        m_delimIsSet = s;
    }
     ...
     * @param s the new value of the flag
     */
    void setQuoteUserSet(final boolean s) {
        m_quoteIsSet = s;
    }
     ...
     * @param s the new value of the flag
     */
    void setWhiteSpaceUserSet(final boolean s) {
        m_whiteIsSet = s;
    }
     ...
     * @param s the new value of the flag
     */
    void setCharsetUserSet(final boolean s) {
        m_charsetIsSet = s;
    }
     ...
     *
     * @param ignoreEm if <code>true</code> extra delims at the end of the row (in case of a tab or space delim) will be
     *            ignored.
     */
    void setIgnoreDelimsAtEndOfRowUserValue(final boolean ignoreEm) {
        m_ignoreDelimsAtEndOfRowIsSet = true;
        m_delimsAtEOLUserValue = ignoreEm;
    }

    /**
     * @return <code>true</code>, if user set the value for "ignore delims at end of row"
     */
     ...
     *
     * @return true, if the user explicitly set the decimal separator, false, if the separators are still at their
     *         default, or the analyser guessed it.
     */
     ...
     */
    void setDecimalSeparatorUserSet(final boolean value) {
    ...
    /**
     * @return the value of the analyze flag previously set. Or <code>false</code> by default.
     */
    ...
    /**
     * Sets the value of the flag which is used to indicate if the {@link FileAnalyzer} looked at all rows when it
     * extracts the default settings. The value of the flag is not stored when the settings are saved into a config, and
     * is not recovered from a config object.
     *
     ...
     * object which contains info, warning and error messages, if something is fishy with the settings.
     *
     * {@inheritDoc}
     */
    @Override
    ...
    /**
     * Call this from derived classes to add the status of all super classes. For parameters:
     *
     * {@inheritDoc}
     */
    @Override
    ...
    private void addThisStatus(final SettingsStatus status) {
        ...
        if (m_numOfColumns < 0) {
            status.addError("Invalid number of columns specified ('" + m_numOfColumns + "').");
            return;
        }
        if (m_columnProperties == null) {
        ...
        if (m_columnProperties.size() < m_numOfColumns) {
            status.addError(
                "Missing column properties for columns " + m_columnProperties.size() + " to " + m_numOfColumns);
        ...
        for (int c = 0; c < propsToCheck; c++) {
            ...
            ColProperty cProp = m_columnProperties.get(c);
            if (cProp == null) {
                status.addError("No column properties specified for column" + " with index " + c);
                // that's all we can do with a null col prop...
                continue;
            }
            // check column spec, i.e. name, type and possible values
            if (cProp.getColumnSpec() == null) {
                status.addError("Column name and type not specified for column" + c);
                continue;
            }
            // check the name
            ...
            if ((cName != null) && !cProp.getSkipThisColumn()) {
                ...
                if (prevCol != null) {
                    status.addError(
                        "Columns with index " + c + " and " + prevCol + " have the same name ('" + cName + "')");
                }
            } // if (cName != null)

            // check a possible values - if any
            Set<DataCell> possVals = cProp.getColumnSpec().getDomain().getValues();
            if (possVals != null) {
                // possible values must not be null
                for (DataCell val : possVals) {
                    if (val == null) {
                        status.addError("Invalid possible value for column " + c + " (<null>).");
                    } else {
                        if (cType != null) {
                            if (!cType.isASuperTypeOf(val.getType())) {
                                status.addError("Incompatible possible " + "value specified for column " + c);
                            }
                        }
                    }
                }
        ...
        if (m_numOfColumns < m_columnProperties.size()) {
            status.addInfo("More column properties specified " + "than number of columns - extra props are unchecked");
