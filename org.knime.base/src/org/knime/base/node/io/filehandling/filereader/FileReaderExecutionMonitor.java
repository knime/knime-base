 ...
 */
final class FileReaderExecutionMonitor extends ExecutionMonitor {
     ...
     */
    private FileReaderExecutionMonitor(final NodeProgressMonitor progressMonitor,
     ...
     * <p>
     * NOTE: if the cancellation was triggered in the progress monitor, this method will return false. Always cancel
     * execution through this execution monitor.
     *
     ...
     */
    void checkInterrupted() throws InterruptedExecutionException {
        if (wasInterrupted()) {
    ...
    void setShortCutLines(final int numOfLines) {
