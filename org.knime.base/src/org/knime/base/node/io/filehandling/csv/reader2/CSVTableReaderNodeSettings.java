...
import org.knime.base.node.io.filehandling.csv.reader2.CSVTableReaderNodeLayout.FileFormat.AutoDetectionButton;
...
import org.knime.core.webui.node.dialog.defaultdialog.widget.WidgetValue;
...
public final class CSVTableReaderNodeSettings implements DefaultNodeSettings {
    ...
    static class Settings implements WidgetGroup, PersistableSettings {
        ...
        @WidgetValue(valueRef = FileChooserRef.class)
        @Layout(Source.class)
        ...
        @WidgetValue(valueRef = CommentStartRef.class)
        ...
        @WidgetValue(valueProvider = ColumnDelimiterProvider.class)
        ...
        @WidgetValue(valueProvider = QuoteCharacterProvider.class)
        ...
        @WidgetValue(valueProvider = QuoteEscapeCharacterProvider.class)
        ...
        @WidgetValue(valueProvider = RowDelimiterOptionProvider.class)
        ...
        @WidgetValue(valueProvider = CustomRowDelimiterProvider.class)
        ...
        @WidgetValue(valueRef = BufferSizeRef.class)
        ...
        @Widget(title = "Autodetect format", description = AutoDetectionButton.DESCRIPTION)
        @Layout(AutoDetectionButton.class)
    ...
    static class LimitRows implements WidgetGroup, PersistableSettings {
        ...
        @WidgetValue(valueRef = SkipFirstLinesRef.class)
        @NumberInputWidget(min = 0)
    ...
    static class Encoding implements WidgetGroup, PersistableSettings {
        ...
        @WidgetValue(valueRef = CharsetRef.class)
