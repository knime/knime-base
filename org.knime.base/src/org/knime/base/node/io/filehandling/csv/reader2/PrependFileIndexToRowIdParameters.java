 ...
 */
@Layout(PrependFileIndexToRowIdLayout.class)
final class PrependFileIndexToRowIdParameters implements NodeParameters {

    @After(MultiFileReaderParameters.HowToCombineColumns.class)
    @Before(MultiFileReaderParameters.AppendFilePathColumn.class)
    interface PrependFileIndexToRowIdLayout {}
