 ...
 */
public interface ClassNoopSerializer extends ExternalDataTypeSerializer<Class<?>> {

    @Override
    default String toSerializableType(final Class<?> externalType) {
        return externalType.getName();
    }

    @Override
    default Class<?> toExternalType(final String serializedType) throws ExternalDataTypeParseException {
        try {
            return Class.forName(serializedType);
        } catch (ClassNotFoundException e) {
            throw new ExternalDataTypeParseException("Loading the type failed.", e);
        }
    }
