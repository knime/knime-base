...
public final class LoopStartGenericDynamicNodeFactory extends
    ...
    @Override
    protected LoopStartGenericDynamicNodeModel createNodeModel(final NodeCreationConfiguration creationConfig) {
        final var config = creationConfig.getPortConfig().orElseThrow();
        return new LoopStartGenericDynamicNodeModel(config.getInputPorts(), config.getOutputPorts());
    }
    ...
    @Override
    public NodeView<LoopStartGenericDynamicNodeModel> createNodeView(final int viewIndex,
        final LoopStartGenericDynamicNodeModel nodeModel) {
        return null;
    }
