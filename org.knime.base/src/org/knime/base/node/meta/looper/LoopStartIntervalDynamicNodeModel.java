 ...
 */
final class LoopStartIntervalDynamicNodeModel extends NodeModel implements
        LoopStartNodeTerminator {

    private double m_value;

    private final LoopStartIntervalDynamicSettings m_settings =
            new LoopStartIntervalDynamicSettings();
