...
public final class LoopStartIntervalDynamicNodeFactory extends
    ...
    @Override
    protected LoopStartIntervalDynamicNodeModel createNodeModel(final NodeCreationConfiguration creationConfig) {
    ...
    @Override
    public NodeView<LoopStartIntervalDynamicNodeModel> createNodeView(final int viewIndex,
        final LoopStartIntervalDynamicNodeModel nodeModel) {
        return null;
    }
