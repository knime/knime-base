    ...
    private static final class TableSettingsPersistor implements NodeParametersPersistor<TableSettings[]> {
        ...
        public TableSettings[] load(final NodeSettingsRO settings) throws InvalidSettingsException {
            ...
            for (int i = 0; i < numberOfPorts; i++) {
                ...
                ts.m_ignoreEmptyTables = i < ignoreEmptyTables.length ? ignoreEmptyTables[i] : true;
                ts.m_tolerateColumnTypes = i < tolerateColumnTypes.length ? tolerateColumnTypes[i] : false;
                ts.m_tolerateChangingSpecs = i < tolerateChangingSpecs.length ? tolerateChangingSpecs[i] : false;
        ...
        public void save(final TableSettings[] value, final NodeSettingsWO settings) {
            ...
            for (int i = 0; i < value.length; i++) {
                ...
                ignoreEmptyTables[i] = tableSetting != null ? tableSetting.m_ignoreEmptyTables : true;
                tolerateColumnTypes[i] = tableSetting != null ? tableSetting.m_tolerateColumnTypes : false;
                tolerateChangingSpecs[i] = tableSetting != null ? tableSetting.m_tolerateChangingSpecs : false;
            }
