...
public final class LoopEndDynamicNodeFactory extends ConfigurableNodeFactory<LoopEndDynamicNodeModel> {
    ...
    protected Optional<PortsConfigurationBuilder> createPortsConfigBuilder() {
        ...
        b.addExtendablePortGroup("Table", new PortType[] {BufferedDataTable.TYPE}, BufferedDataTable.TYPE);
     ...
     */
    @Override
    public NodeView<LoopEndDynamicNodeModel> createNodeView(final int viewIndex, final LoopEndDynamicNodeModel nodeModel) {
        return null;
    }
