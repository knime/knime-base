...
public final class LoopEndVariableNodeFactory extends NodeFactory<LoopEndVariableNodeModel> implements NodeDialogFactory {
    ...
    public LoopEndVariableNodeModel createNodeModel() {
        return new LoopEndVariableNodeModel();
    }
    ...
    @Override
    public NodeView<LoopEndVariableNodeModel> createNodeView(final int viewIndex,
        final LoopEndVariableNodeModel nodeModel) {
        return null;
    }
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, LoopEndVariableSettings.class);
    }
