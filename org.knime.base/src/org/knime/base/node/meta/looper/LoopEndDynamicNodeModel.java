    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec)
        ...
        if (m_tableFactories == null) {
            ...
            m_tableFactories = IntStream.range(0, inData.length)//
                .mapToObj(i -> new ConcatenateTableFactory(m_settings.ignoreEmptyTables(i), m_settings.tolerateColumnTypes(i),
                        m_settings.addIterationColumn(), m_settings.tolerateChangingTableSpecs(i), getRowKeyFunction(i)))//
        ...
        switch (m_settings.rowKeyPolicy()) {
            ...
            case GENERATE_NEW:
                    return Optional.of(k -> {
                        final var key = new RowKey("Row" + m_counts[tableNumber]);
