 ...
 * @param <T> The exact type of collection. Unfortunately, vectors and collections don't have a more specific common
 *            interface
 */
abstract class AbstractCollectionFeatureHandlerFactory<T extends DataValue>
    extends AbstractFeatureHandlerFactory<T> {

    /**
     * {@inheritDoc}
     */
    @Override
    public final List<String> getFeatureNames(final DataColumnSpec columnSpec) {
        return columnSpec.getElementNames();
    }
    ...
    public boolean supportsMissingValues() {
        // it's not possible to replace individual elements if the entire collection is missing
        return false;
    }
