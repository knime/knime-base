...
/**
 * Builder for NumericalFeatureStatistic objects.
 *
...
final class NumericFeatureStatisticBuilder implements FeatureStatisticBuilder<NumericFeatureStatistic> {
    ...
    /**
     * @param accessor allows to extract the relevant double value for this builder from an incoming {@link DataCell}
     * @param correctSampleBias flag indicating whether the variance should take the sampling bias into account
     */
    ...
    public void consume(final DataCell cell) {
        final double value = m_accessor.getValue(cell);
        m_sum += value;
