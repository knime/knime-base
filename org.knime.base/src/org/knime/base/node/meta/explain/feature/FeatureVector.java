...
/**
 * Object of this class are a symbolic representation of feature vectors but don't
 * actually allow to access the individual feature values.
 * There purpose is to allow algorithms such as the Shapley Values algorithm to create
 * perturbed copies of the represented feature vector.
 *
