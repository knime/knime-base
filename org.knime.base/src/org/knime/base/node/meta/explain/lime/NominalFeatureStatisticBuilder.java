...
import org.knime.base.node.meta.explain.util.valueaccess.NominalValueAccessor;
import org.knime.core.data.DataCell;
import org.knime.core.node.util.CheckUtils;

/**
 * Builds a NominalFeatureStatistic
 *
...
final class NominalFeatureStatisticBuilder implements FeatureStatisticBuilder<NominalFeatureStatistic> {
    ...
    public void consume(final DataCell cell) {
        final DataCell val = m_accessor.getValue(cell);
