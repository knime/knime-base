...
/**
 * Creates panel and manages components of the advanced tab of the loop start dialog.
 *
...
class AdvancedOptionsDialog {
    ...
    void loadSettingsFrom(final ShapleyValuesSettings cfg) throws NotConfigurableException {
