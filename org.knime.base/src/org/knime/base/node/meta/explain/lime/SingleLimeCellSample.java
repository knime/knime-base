...
/**
 * LimeCellSample for ordinary columns (i.e. that represent only a single feature such as nominal and numeric columns).
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
final class SingleLimeCellSample implements LimeCellSample {
    ...
    SingleLimeCellSample(final DataCell cell, final DataCell inverse, final double normalized) {
        m_cell = cell;
        m_inverse = inverse;
    ...
    public DoubleIterator iterator() {
        return IteratorUtils.singletonDoubleIterator(m_normalized);
    }
    ...
    public Iterable<DataCell> getData() {
        return Collections.singleton(m_cell);
    }
