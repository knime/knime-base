...
public interface NominalValueAccessor extends ValueAccessor {
    ...
    /**
     * Checks if cell is nominal and returns it.
     *
     * @param cell nominal cell
     * @return <b>cell</b>
     * @throws IllegalArgumentException if cell doesn't implement {@link NominalValue}
     */
    DataCell getValue(final DataCell cell);
}
