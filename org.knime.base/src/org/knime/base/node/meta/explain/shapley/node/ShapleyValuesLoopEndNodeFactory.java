...
public class ShapleyValuesLoopEndNodeFactory extends NodeFactory<ShapleyValuesLoopEndNodeModel> {
     ...
     */
    @Override
    public ShapleyValuesLoopEndNodeModel createNodeModel() {
        return new ShapleyValuesLoopEndNodeModel();
    }
     ...
     */
    @Override
    public NodeView<ShapleyValuesLoopEndNodeModel> createNodeView(final int viewIndex,
        final ShapleyValuesLoopEndNodeModel nodeModel) {
        return null;
    }
