...
/**
 * Factory for a Selection Loop Start node with one in and out port.
 *
...
public class FeatureSelectionLoopStartNodeFactory extends NodeFactory<FeatureSelectionLoopStartNodeModel>
    ...
    private static final String NODE_NAME = "Feature Selection Loop Start (1:1)";
    ...
    private static final String FULL_DESCRIPTION = """
            This node is the start of the feature selection loop. The feature selection loop allows you to select,
                ...
                its settings; and (iii) the specific settings of the selected strategy. <br />
