...
public class PMMLRegressionPredictorOptions {
     ...
     */
    public PMMLRegressionPredictorOptions(final String customPredictionName) {
        m_customPredictionName = customPredictionName;
    }

    /**
     * Creates a new instance of {@code PMMLMlpPredictorOptions}, determining that
     * the default name from the PMML is used for the prediction column.
     */
    public PMMLRegressionPredictorOptions() {
        this(null);
    }
     ...
     */
    public boolean hasCustomPredictionName() {
