...
public interface PredictorContext {
    /**
     * @return the execution context for the predictor. Can be null if none is available (eg for configure).
     */
    public ExecutionContext getExecutionContext();

    /**
     * Instructs the context to display a warning message to the user.
