...
public class SingleDateTimeFieldPanel extends JPanel implements OperatorPanel {
    ...
    private static final long serialVersionUID = 9152466664831283145L;

    private final DateTimeField m_field;

    /**
     * Constructs a {@link SingleDateTimeFieldPanel} object.
     */
    public SingleDateTimeFieldPanel() {
        setLayout(new BoxLayout(this, BoxLayout.Y_AXIS));
        m_field = new DateTimeField(this, LocalDateCellFactory.TYPE);
    }

    @Override
    public void init(final OperatorPanelParameters parameters) {
        m_field.setType(parameters.getColumnSpec().getType());
        final String[] values = parameters.getValues();
        m_field.setValue(values == null || values.length == 0 ? null : values[0]);
    }
    ...
    public String[] getValues() {
        return new String[]{m_field.getValue()};
    }
