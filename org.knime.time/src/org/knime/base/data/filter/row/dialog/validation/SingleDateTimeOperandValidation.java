 ...
 * @since 4.0
 */
public class SingleDateTimeOperandValidation implements DateTimeOperatorValidation {
    ...
    public ValidationResult apply(final OperatorParameters parameters) {
        ...
        if (values == null || values.length != 1) {
            result.addError(ValidationResult.COMMON_ERROR_ID, "Only one value is allowed");
        } else {
