...
public interface DateTimeOperatorRegistry<F extends OperatorFunction<?, ?>> extends OperatorRegistry<F> {
     ...
     */
    default void addDateTimeOperator(final Operator key, final OperatorValue<F> value) {
        addOperator(OperatorKey.key(LocalDateCellFactory.TYPE, key), value);
        addOperator(OperatorKey.key(LocalDateTimeCellFactory.TYPE, key), value);
        addOperator(OperatorKey.key(LocalTimeCellFactory.TYPE, key), value);
    }
}
