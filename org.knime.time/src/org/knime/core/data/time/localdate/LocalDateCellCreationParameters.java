...
/**
 * Creation node parameters for a {@link LocalDateCell}.
 *
 * @author Paul Bärnreuther
 */
public class LocalDateCellCreationParameters implements CreateDataCellParameters.SpecificTypeParameters {

    @Widget(title = CUSTOM_VALUE_TITLE, description = CUSTOM_VALUE_DESCRIPTION)
    LocalDate m_value = LocalDate.now();
    ...
    public DataCell createSpecificCell() {
        return new LocalDateCell(m_value);
    }
