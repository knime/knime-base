...
/**
 * Creation node parameters for a {@link ZonedDateTimeCell}.
 *
 * @author Paul Bärnreuther
 */
public class ZonedDateTimeCellCreationParameters implements CreateDataCellParameters.SpecificTypeParameters {

    @Widget(title = CUSTOM_VALUE_TITLE, description = CUSTOM_VALUE_DESCRIPTION)
    ZonedDateTime m_value = ZonedDateTime.now();
    ...
    public DataCell createSpecificCell() {
        return new ZonedDateTimeCell(m_value);
    }
