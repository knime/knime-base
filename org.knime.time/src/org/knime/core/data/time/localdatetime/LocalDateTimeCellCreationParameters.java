...
/**
 * Creation node parameters for a {@link LocalDateTimeCell}.
 *
 * @author Paul Bärnreuther
 */
public class LocalDateTimeCellCreationParameters implements CreateDataCellParameters.SpecificTypeParameters {

    @Widget(title = CUSTOM_VALUE_TITLE, description = CUSTOM_VALUE_DESCRIPTION)
    LocalDateTime m_value = LocalDateTime.now();
    ...
    public DataCell createSpecificCell() {
        return new LocalDateTimeCell(m_value);
    }
