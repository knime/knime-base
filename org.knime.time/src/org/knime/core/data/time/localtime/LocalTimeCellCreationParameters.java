...
/**
 * Creation node parameters for a {@link LocalTimeCell}.
 *
 * @author Paul Bärnreuther
 */
public class LocalTimeCellCreationParameters implements CreateDataCellParameters.SpecificTypeParameters {

    @Widget(title = CUSTOM_VALUE_TITLE, description = CUSTOM_VALUE_DESCRIPTION)
    LocalTime m_value = LocalTime.now();
    ...
    public DataCell createSpecificCell() {
        return new LocalTimeCell(m_value);
    }
