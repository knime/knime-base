...
public final class CreateDateTimeNodeFactory2 extends WebUINodeFactory<CreateDateTimeNodeModel2> {
    ...
    private static final WebUINodeConfiguration CONFIGURATION = WebUINodeConfiguration.builder() //
        ...
        .fullDescription("""
                ...
                <ul>
                    <li>a number of rows, a starting point, and an ending point is selected \
                    (the steps in between will be calculated)</li>
                    <li>a number of rows, a starting point and an interval is selected \
                    (the interval defines the steps between each row)</li>
                    <li>a starting point, an ending point and an interval is selected \
                    (the number of rows corresponds to how often the interval fits between start and end).</li>
                </ul> \
                """) //
