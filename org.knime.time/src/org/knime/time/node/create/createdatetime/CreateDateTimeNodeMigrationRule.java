        ...
        try {
            ...
            switch (newSettings.m_outputType) {
                ...
                case ZONED_DATE_TIME:
                    ...
                    newSettings.m_zonedDateTimeEnd = LocalDateTime.parse(origModelSettings.getString(END_CFG_KEY))
                        .atZone(newSettings.m_zonedDateTimeStart.getZone());
                    if (oldVariableKey == END_CFG_KEY) {
                        throw new MigrationException("Variable with zoned end time");
                    }
                    break;
            }
            ...
            if (!useVariableNrRows) {
                if (useEnd) {
                    ...
                    if (newSettings.m_interval.isZero()) {
                        throw new MigrationException("Interval is zero");
                    }
