...
/**
 * The node factory of the node which rounds times.
 *
 * @author Tobias Kampmann, TNG Technology Consulting GmbH
 */
@SuppressWarnings("restriction")
public final class TimeRoundNodeFactory extends WebUINodeFactory<TimeRoundNodeModel> {

    @Override
    public TimeRoundNodeModel createNodeModel() {
        return new TimeRoundNodeModel(CONFIGURATION);
    }
