...
public final class DateTimeDifferenceNodeFactory2 extends WebUINodeFactory<DateTimeDifferenceNodeModel2> {
    ...
    private static final WebUINodeConfiguration CONFIGURATION = WebUINodeConfiguration.builder() //
        .name("DateTime Difference (Labs)") //
        .icon("date_time_difference.png") //
        .shortDescription("Calculates differences between two datetimes.") //
        .fullDescription("""
                Calculates differences between two date&amp;time cells and appends a new \
                column. The output can be either a duration or a number with a selected granularity \
                (years, months, weeks, days, hours, minutes, seconds, milliseconds, \
                nanosseconds). It can be configured to use as second date&amp;time either \
