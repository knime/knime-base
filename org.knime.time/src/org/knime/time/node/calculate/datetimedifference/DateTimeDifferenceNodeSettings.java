...
public class DateTimeDifferenceNodeSettings implements DefaultNodeSettings {
    ...
    @Widget(title = "First Date Time column", description = """
            ...
            from each other depending on the 'mode' option.
            """)
    @Persist(configKey = "col_select1")
    ...
    @Widget(title = "Second Date Time value", description = """
            The second date&amp;time column. The first and second column will be subtracted \
            from each other depending on the 'mode' option.
            """)
    ...
    @Widget(title = "Second Date Time column",
        description = "The date&amp;time column that is subtracted from the first column.")
    @Persist(configKey = "col_select2")
    ...
    @Widget(title = "Mode", description = """
            The mode in which the date&amp;time columns are subtracted from each other: either \
            subtract the second column from the first column or subtract the first column from the \
            second column.
            """)
    @Layout(DifferencingSettingsSection.class)
    @ValueSwitchWidget
    ...
    @Widget(title = "Granularity", description = """
            The granularity of the output column.
            """)
    @Layout(OutputSettingsSection.class)
    @Effect(predicate = OutputType.IsNumber.class, type = EffectType.SHOW)
    Granularity m_granularity = Granularity.SECOND;

    @Widget(title = "Output number type", description = """
            The type of the output number column.
            """)
    @Layout(OutputSettingsSection.class)
    @Effect(predicate = OutputType.IsNumber.class, type = EffectType.SHOW)
    @ValueSwitchWidget
    ...
    @Layout(OutputSettingsSection.class)
    @Persist(configKey = "new_col_name")
