 ...
 */
public interface InputPreviewMessageProvider extends StateProvider<Optional<TextMessage.Message>> {
    ...
    default String description(final NodeParametersInput context) {
        var portObjectSpecs = context.getInPortSpecs();
        ...
        Optional<BufferedDataTable> dt =
            inputPorts != null && inputPorts.length > 0 ? context.getInTable(0) : Optional.empty();
