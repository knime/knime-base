...
class TimestampToDateTimeNodeSettings implements DefaultNodeSettings {
    ...
    TimestampToDateTimeNodeSettings(final DefaultNodeSettingsContext context) {
        ...
        if (spec.isPresent()) {
            ...
            m_timestampColumns = new ColumnFilter(timestampColumns).withIncludeUnknownColumns();
        }
    }
    ...
    ColumnFilter m_timestampColumns = new ColumnFilter().withIncludeUnknownColumns();
