 ...
 */
public final class DateTimeToStringNodeMigrationRule extends NodeMigrationRule {
    ...
    protected Class<? extends NodeFactory<?>> getReplacementNodeFactoryClass(final MigrationNode migrationNode,
        ...
        return DateTimeToStringNodeFactory2.class;
    }
    ...
    protected MigrationNodeMatchResult match(final MigrationNode migrationNode) {
        if ("org.knime.time.node.convert.datetimetostring.DateTimeToStringNodeFactory"
    ...
    private static Pair<DateTimeToStringNodeSettings, NodeSettingsRO>
        ...
        final var newSettings = new DateTimeToStringNodeSettings();
        try {
