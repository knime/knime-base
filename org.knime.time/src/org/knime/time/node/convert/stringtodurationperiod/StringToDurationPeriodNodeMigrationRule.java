 ...
 */
public class StringToDurationPeriodNodeMigrationRule extends NodeMigrationRule {
    ...
    protected Class<? extends NodeFactory<?>> getReplacementNodeFactoryClass(final MigrationNode migrationNode,
        ...
        return StringToDurationPeriodNodeFactory2.class;
    }

    @Override
    protected MigrationNodeMatchResult match(final MigrationNode migrationNode) {
        if ("org.knime.time.node.convert.stringtodurationperiod.StringToDurationPeriodNodeFactory"
    ...
    private static Pair<StringToDurationPeriodNodeSettings, NodeSettingsRO>
        performMigration(final MigrationNode migrationNode) throws MigrationException {
        final var newSettings = new StringToDurationPeriodNodeSettings();
