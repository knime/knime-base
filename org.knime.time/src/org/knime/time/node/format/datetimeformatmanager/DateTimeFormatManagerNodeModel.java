...
final class DateTimeFormatManagerNodeModel extends WebUINodeModel<DateTimeFormatManagerNodeSettings> {
    ...
    protected DataTableSpec[] configure(final DataTableSpec[] inSpecs,
        ...
        return new DataTableSpec[]{addFormatterToSelectedColumns(inSpecs[0], modelSettings)};
    }
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec,
        ...
        var resultSpec = addFormatterToSelectedColumns(inputSpec, modelSettings);
    ...
    static DataTableSpec addFormatterToSelectedColumns(final DataTableSpec spec,
        final DateTimeFormatManagerNodeSettings settings) throws InvalidSettingsException {

        ComprehensiveDateTimeFormatProvider.addFormatToStringHistoryIfNotPresent(settings.m_format);
