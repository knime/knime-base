 ...
 *
 * History
 *   May 26, 2020 (Simon Schmid, KNIME GmbH, Konstanz, Germany): created
 */
...
public final class CheckNodeContextUtil {
     ...
     */
    private CheckNodeContextUtil() {
    }

    /**
     * Checks if the node is running in the remote workflow context.
     *
     * @return {@code true} if the node is running in the remote workflow context
     */
