...
/**
 * File chooser dialog component for Item Version Creator node.
 *
 * @author Zkriya Rakhimberdiyev
 */
public final class DialogComponentItemChooser
    extends AbstractDialogComponentFileChooser<SettingsModelItemChooser> {
     ...
     */
    public DialogComponentItemChooser(final SettingsModelItemChooser model, final String historyID,
        final FlowVariableModel locationFvm) {
        super(model, historyID, DialogType.OPEN_DIALOG, "Item location", locationFvm,
