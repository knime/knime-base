...
public final class FileFilterStatistic {
     ...
     * @param filteredSpecialFiles the number of filtered special files
     ...
     */
    public FileFilterStatistic(final int filteredFiles, final int filteredHiddenFiles, final int filteredSpecialFiles,
        final int visitedFiles, final int filteredFolders, final int filteredHiddenFolders, final int visitedFolders) {
        m_filteredFiles = filteredFiles;
        m_visitedFiles = visitedFiles - filteredHiddenFiles - filteredSpecialFiles;
