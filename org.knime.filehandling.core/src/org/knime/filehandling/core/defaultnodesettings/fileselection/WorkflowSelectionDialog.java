...
/**
 * A file selection dialog where only workflow can be selected.
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 */
public class WorkflowSelectionDialog extends FileSelectionDialog {

    /**
     * Creates a new dialog.
     *
     * @param historyID ID for storing a workflow selection history
     * @param historyLength the number of entries to store in the workflow history
     ...
     */
    public WorkflowSelectionDialog(final String historyID, final int historyLength,
        final CheckedExceptionSupplier<FSConnection, IOException> fileSystemBrowserSupplier,
        final DialogType dialogType) {
        super(historyID, historyLength, fileSystemBrowserSupplier, dialogType, FileSelectionMode.FILES_ONLY,
            new String[0]);
    }
    ...
    protected String openDialogAndGetFile(final FileSystemBrowser fsBrowser, final FileSelectionMode fileSelectionMode,
        ...
        return fsBrowser.openDialogAndGetSelectedWorkflow(dialogType, parent, currentlySelected);
    }
