 ...
 */
public interface GenericRowKeyGeneratorContext<I, V> {

    /**
     * Creates a {@link RowKeyGenerator} for the provided item.
     *
     * @param item the item the created {@link RowKeyGenerator} receives rows from
     * @return a {@link RowKeyGenerator} for item
     */
    RowKeyGenerator<V> createKeyGenerator(I item);
