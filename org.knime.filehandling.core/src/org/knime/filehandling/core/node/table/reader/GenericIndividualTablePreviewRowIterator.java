 ...
 */
public class GenericIndividualTablePreviewRowIterator<I, V> extends PreviewRowIterator {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(GenericIndividualTablePreviewRowIterator.class);

    private final GenericRead<I, V> m_read;
     ...
     */
    public GenericIndividualTablePreviewRowIterator(final GenericRead<I, V> read,
