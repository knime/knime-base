...
import org.knime.filehandling.core.node.table.reader.read.GenericAbstractReadDecorator;
 ...
 */
class GenericColumnFilterRead<I, V> extends GenericAbstractReadDecorator<I, V> {
     ...
     */
    GenericColumnFilterRead(final GenericRead<I, V> source, final int columnToFilter) {
        super(source);
