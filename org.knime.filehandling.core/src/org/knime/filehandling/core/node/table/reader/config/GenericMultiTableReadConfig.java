 ...
 */
public interface GenericMultiTableReadConfig<I, C extends ReaderSpecificConfig<C>> {
     ...
     */
    void setTableSpecConfig(GenericTableSpecConfig<I> config);
     ...
     *         parameters
     */
    default boolean isConfiguredWith(final String rootItem, final List<I> items) {
