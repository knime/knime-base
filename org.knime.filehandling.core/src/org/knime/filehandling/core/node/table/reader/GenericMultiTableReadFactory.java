 ...
 */
public interface GenericMultiTableReadFactory<I, C extends ReaderSpecificConfig<C>, T> {
     ...
     */
    GenericStagedMultiTableRead<I, T> create(String rootItem, List<I> items, GenericMultiTableReadConfig<I, C> config,
     ...
     */
    GenericStagedMultiTableRead<I, T> createFromConfig(String rootItem, List<I> items,
        GenericMultiTableReadConfig<I, C> config);
