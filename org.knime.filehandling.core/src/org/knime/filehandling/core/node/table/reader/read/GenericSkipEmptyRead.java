...
/**
 * Skips calls to {@link Read#next()} if the returned {@link RandomAccessible} is empty.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
class GenericSkipEmptyRead<I, V> extends GenericAbstractReadDecorator<I, V> {
     ...
     */
    GenericSkipEmptyRead(final GenericRead<I, V> source) {
        super(source);
    }
