...
/**
 * A {@link MultiTableReadConfig} that has method to load, save and validate the {@link NodeSettings}.
 *
 ...
 */
public interface GenericStorableMultiTableReadConfig<I, C extends ReaderSpecificConfig<C>>
    extends GenericMultiTableReadConfig<I, C>, StorableReaderConfig {
    // Marker interface
}
