 ...
 */
public abstract class GenericAbstractMultiTableReadConfig<I, C extends ReaderSpecificConfig<C>, TC extends TableReadConfig<C>>
    implements GenericMultiTableReadConfig<I, C> {

    private final TC m_tableReadConfig;

    private GenericTableSpecConfig<I> m_tableSpecConfig = null;
     ...
     *
     */
    public GenericAbstractMultiTableReadConfig(final TC tableReadConfig) {
