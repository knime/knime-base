 ...
 */
public class GenericDefaultIndividualTableReader<I, V> implements GenericIndividualTableReader<I, V> {
     ...
     */
    public GenericDefaultIndividualTableReader(final TypeMapper<V> typeMapper, final IndexMapper idxMapper,
    ...
    @Override
    public void fillOutput(final GenericRead<I, V> read, final RowOutput output, final ExecutionMonitor progress)
        throws Exception {
    ...
    private void fillOutputWithoutProgress(final GenericRead<I, V> read, final RowOutput output,
    ...
    private void fillOutputWithProgress(final GenericRead<I, V> read, final RowOutput output,
