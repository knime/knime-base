 ...
 */
public abstract class GenericAbstractReadDecorator<I, V> implements GenericRead<I, V> {

    private final GenericRead<I, V> m_source;
     ...
     */
    protected GenericAbstractReadDecorator(final GenericRead<I, V> source) {
     ...
     */
    protected final GenericRead<I, V> getSource() {
        return m_source;
    }
