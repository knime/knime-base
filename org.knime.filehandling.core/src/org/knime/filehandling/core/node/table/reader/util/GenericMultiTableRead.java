...
/**
 * Gneric multi table read interface.
 *
 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
 * @param <I> the item type to read from
 */
public interface GenericMultiTableRead<I> {
     ...
     */
    void fillRowOutput(RowOutput output, ExecutionMonitor exec, FileStoreFactory fsFactory) throws Exception; // NOSONAR, can't be specialized because the type mapping throws Exception
