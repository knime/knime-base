...
/**
 * Empty panel for {@link EmptyAuthProviderSettings}.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 */
@SuppressWarnings("serial")
public class EmptyAuthProviderPanel extends AuthProviderPanel<EmptyAuthProviderSettings> {
     ...
     * @param settings
     */
    public EmptyAuthProviderPanel(final EmptyAuthProviderSettings settings) {
