 ...
 *
 * History
 *   Dec 2, 2020 (Bjoern Lohrmann, KNIME GmbH): created
 */
...
/**
 * Empty auth provider settings for authentication schemes that do not require any settings.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 */
public final class EmptyAuthProviderSettings implements AuthProviderSettings {
     ...
     * @param authType
     */
    public EmptyAuthProviderSettings(final AuthType authType) {
        m_authType = authType;
    }
