...
/**
 * Snapshot test for {@link ARFFWriterNodeParameters}.
 *
...
final class ARFFWriterNodeParametersTest extends DefaultNodeSettingsSnapshotTest {
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(ARFFWriterNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .build();
    }

    private static ARFFWriterNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(ARFFWriterNodeParameters.class).getParent() //
                .resolve("node_settings") //
                .resolve("ARFFWriterNodeParameters.xml");
