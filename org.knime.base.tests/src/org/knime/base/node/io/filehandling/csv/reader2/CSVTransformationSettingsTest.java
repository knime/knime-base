...
import org.knime.base.node.io.filehandling.csv.reader2.CSVTransformationSettings.SourceIdProvider;
...
class CSVTransformationSettingsTest {
    ...
    void testSourceIdProvider() {
        ...
        sourceIdProvider.init(getSourceIdProviderStateProviderInitializer(settings));
        final var sourceId = sourceIdProvider.computeState(null);
        assertThat(sourceId).isEqualTo("foo");
    }

    private static final StateProviderInitializer
        getSourceIdProviderStateProviderInitializer(final CSVTableReaderNodeSettings settings) {
