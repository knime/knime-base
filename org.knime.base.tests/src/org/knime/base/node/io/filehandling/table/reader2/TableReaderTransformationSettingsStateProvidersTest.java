 ...
 */
final class TableReaderTransformationSettingsStateProvidersTest
    ...
    @Override
    protected CommonReaderTransformationSettings<?, String>
        getTransformationSettings(final TableReaderNodeSettings settings) {
    ...
    protected String getFileName() {
        return "file.table.gz";
    }

    @Override
    protected ProductionPathProvider<DataType> getProductionPathProvider() {
        return TableReaderSpecific.PRODUCTION_PATH_PROVIDER;
    }
    ...
    @Override
    protected TableReaderNodeSettings constructNewSettings() {
        return new TableReaderNodeSettings();
    }
