...
final class ColorDesignerApplyNodeFactoryConfigureTest {
    ...
    @ParameterizedTest
    void testConfigureReturnsInputSpecsForIncorrectModelSpec(final DataTableSpec modelSpec)
    ...
    void testConfigureWithRangeModelPercentageBased() throws InvalidSettingsException {
        ...
        final var colorModel = new ColorModelRange(SPECIAL_COLORS, ColorGradient.PURPLE_GREEN_5);
        ...
        final var resultColorModel =
            new ColorModelRange(SPECIAL_COLORS, ColorGradient.PURPLE_GREEN_5).applyToDomain(0, 50);
        assertThat(outputModelSpec.getColumnSpec(0).getColorHandler().getColorModel()).isEqualTo(resultColorModel);
    ...
    void testConfigureWithRangeModelAbsoluteBased() throws InvalidSettingsException {
        ...
        final var colorModel = new ColorModelRange(SPECIAL_COLORS, new double[]{10, 20, 30, 40, 50},
    ...
    private static final Map<DataCell, ColorAttr> INITIIAL_COLOR_MAP = Map.<DataCell, ColorAttr> of( //
    ...
    private static DataTableSpec createModelSpecWithNominalColorHandler() {
    ...
    private static final Map<SpecialColorType, Color> SPECIAL_COLORS = Map.of(//
