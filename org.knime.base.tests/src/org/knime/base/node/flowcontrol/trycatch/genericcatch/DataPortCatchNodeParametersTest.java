...
/**
 * Snapshot test for the Catch Errors (Data Ports) node settings.
 *
 * @author AI Migration
 */
@SuppressWarnings("restriction")
final class DataPortCatchNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    DataPortCatchNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(GenericCatchNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static GenericCatchNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(GenericCatchNodeParameters.class).getParent().resolve("node_settings")
                .resolve("DataPortCatchNodeParameters.xml");
