...
/**
 * Snapshot test for the Catch Errors (Generic Ports) node settings.
 *
 * @author AI Migration
 */
@SuppressWarnings("restriction")
final class GenericCatchNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    GenericCatchNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static GenericCatchNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(GenericCatchNodeParameters.class).getParent().resolve("node_settings")
                .resolve("GenericPortCatchNodeParameters.xml");
    ...
    private static PortObjectSpec[] createInputPortSpecs() {
        // Generic ports can handle any type of port object
