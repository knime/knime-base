...
public class AppendVariableToTable4NodeModel2Test {

    private static final String NODE_NAME = "VariableToTableColumn";

    private static final String INPUT_COLUMN = "column1";

    private static final Class<? extends DefaultNodeSettings> SETTINGS_CLASS = AppendVariableToTable4NodeSettings.class;
    ...
    void testExecute() throws InvalidSettingsException, IOException {
        ...
        settings.m_filter =
            new ColumnFilter(Arrays.stream(variables).map(FlowVariable::getName).toArray(String[]::new));
    ...
    private static BufferedDataTable setupAndExecuteWorkflow(final AppendVariableToTable4NodeSettings settings,
        ...
        var node = WorkflowManagerUtil.createAndAddNode(workflowManager, new AppendVariableToTable4NodeFactory2());
        // set the settings
