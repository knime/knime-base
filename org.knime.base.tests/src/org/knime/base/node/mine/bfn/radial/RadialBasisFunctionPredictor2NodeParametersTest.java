...
final class RadialBasisFunctionPredictor2NodeParametersTest extends DefaultNodeSettingsSnapshotTest {
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(RadialBasisFunctionPredictor2NodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static RadialBasisFunctionPredictor2NodeParameters readSettings() {
        try {
            var path = getSnapshotPath(RadialBasisFunctionPredictor2NodeParameters.class).getParent()
