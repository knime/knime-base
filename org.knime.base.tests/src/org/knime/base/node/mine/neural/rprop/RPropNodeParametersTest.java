...
/**
 * Snapshot test for RPropNodeParameters.
 */
@SuppressWarnings("restriction")
final class RPropNodeParametersTest extends DefaultNodeSettingsSnapshotTest {
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(RPropNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static RPropNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(RPropNodeParameters.class).getParent().resolve("node_settings")
                .resolve("RPropNodeParameters.xml");
