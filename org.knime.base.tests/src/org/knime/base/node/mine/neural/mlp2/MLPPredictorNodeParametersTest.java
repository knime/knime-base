...
/**
 * Snapshot test for MLPPredictorNodeParameters.
 */
@SuppressWarnings("restriction")
final class MLPPredictorNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    static final PortObjectSpec[] TEST_SPECS = new PortObjectSpec[]{//
        // Port 0: Trained MLP model (PMML)
        createPMMLPortObjectSpec(), //
        // Port 1: Test data with features and target column
        new DataTableSpec(
    ...
    MLPPredictorNodeParametersTest() {
        super(getConfig());
    }

    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            .withInputPortObjectSpecs(TEST_SPECS) //
            .testJsonFormsForModel(MLPPredictorNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static MLPPredictorNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(MLPPredictorNodeParameters.class).getParent().resolve("node_settings")
                .resolve("MLPPredictorNodeParameters.xml");
