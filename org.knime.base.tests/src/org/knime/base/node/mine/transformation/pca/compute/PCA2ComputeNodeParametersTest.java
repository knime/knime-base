...
/**
 * Snapshot test for PCA2ComputeNodeParameters.
 *
 * @author Magnus Gohm, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("restriction")
final class PCA2ComputeNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    PCA2ComputeNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(PCA2ComputeNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static PCA2ComputeNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(PCA2ComputeNodeParameters.class).getParent().resolve("node_settings")
                .resolve("PCA2ComputeNodeParameters.xml");
