...
/**
 * Snapshot test for {@link DecTreeToImageNodeParameters}.
 */
@SuppressWarnings("restriction")
final class DecTreeToImageNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    DecTreeToImageNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(DecTreeToImageNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static DecTreeToImageNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(DecTreeToImageNodeParameters.class).getParent().resolve("node_settings")
                .resolve("DecTreeToImageNodeParameters.xml");
    ...
    private static PortObjectSpec createPMMLPortObjectSpec() {
        var targetColumn = new DataColumnSpecCreator("Class", StringCell.TYPE).createSpec();
        var dataTableSpec = new DataTableSpec(targetColumn);
        var pmmlSpecCreator = new PMMLPortObjectSpecCreator(dataTableSpec);
        pmmlSpecCreator.setTargetColName("Class");
