...
/**
 * Snapshot test for the SVM Predictor node settings.
 * @author AI Migration Pipeline v1.2
 */
@SuppressWarnings("restriction")
final class SVMPredictorNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    SVMPredictorNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(SVMPredictorNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static SVMPredictorNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(SVMPredictorNodeParameters.class).getParent()
                .resolve("node_settings").resolve("SVMPredictorNodeParameters.xml");
            try (var fis = new FileInputStream(path.toFile())) {
                var nodeSettings = NodeSettings.loadFromXML(fis);
                return NodeParametersUtil.loadSettings(nodeSettings.getNodeSettings(SettingsType.MODEL.getConfigKey()),
                    SVMPredictorNodeParameters.class);
            }
