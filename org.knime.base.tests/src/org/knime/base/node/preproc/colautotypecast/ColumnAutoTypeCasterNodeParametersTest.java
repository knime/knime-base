...
final class ColumnAutoTypeCasterNodeParametersTest extends DefaultNodeSettingsSnapshotTest {
    ...
    protected ColumnAutoTypeCasterNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(ColumnAutoTypeCasterNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static ColumnAutoTypeCasterNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(ColumnAutoTypeCasterNodeParameters.class).getParent().resolve("node_settings")
