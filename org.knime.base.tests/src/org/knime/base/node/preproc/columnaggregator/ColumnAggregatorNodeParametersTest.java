...
class ColumnAggregatorNodeParametersTest extends DefaultNodeSettingsSnapshotTest {
    ...
    ColumnAggregatorNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(ColumnAggregatorNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static ColumnAggregatorNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(ColumnAggregatorNodeParameters.class).getParent().resolve("node_settings")
                .resolve("ColumnAggregatorNodeParameters.xml");
