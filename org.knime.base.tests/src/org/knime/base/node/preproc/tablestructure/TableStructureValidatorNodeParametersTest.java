...
/**
 * Snapshot test for {@link TableStructureValidatorNodeParameters}.
 */
...
final class TableStructureValidatorNodeParametersTest extends DefaultNodeSettingsSnapshotTest {
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(TableStructureValidatorNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static TableStructureValidatorNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(TableStructureValidatorNodeParameters.class).getParent().resolve("node_settings")
                .resolve("TableStructureValidatorNodeParameters.xml");
