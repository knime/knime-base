...
final class ConstantValueColumnNodeSettingsTest extends DefaultNodeSettingsSnapshotTest {
    ...
    ConstantValueColumnNodeSettingsTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(ConstantValueColumnNodeSettings.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static ConstantValueColumnNodeSettings readSettings() {
        try {
            var path = getSnapshotPath(ConstantValueColumnNodeSettings.class).getParent().resolve("node_settings")
                .resolve("ConstantValueColumnNodeSettings.xml");
            try (var fis = new FileInputStream(path.toFile())) {
                var nodeSettings = NodeSettings.loadFromXML(fis);
                return DefaultNodeSettings.loadSettings(nodeSettings.getNodeSettings(SettingsType.MODEL.getConfigKey()),
                    ConstantValueColumnNodeSettings.class);
            }
