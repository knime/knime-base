...
/**
 * Tests for the ColumnFilterNodeSettings choices provider.
 *
 * @author Manuel Hotz, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("restriction")// WebUI* classes
class ColumnFilterNodeSettingsTest {
    ...
    void testColumnChoicesProvider() {
        ...
        final var choices = new ColumnFilterNodeSettings.AllColumns().columnChoices(ctx);
