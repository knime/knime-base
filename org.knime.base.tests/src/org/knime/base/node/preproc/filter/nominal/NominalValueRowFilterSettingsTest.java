...
/**
 * {@link DefaultNodeSettingsSnapshotTest} for the {@link NominalValueRowFilterSettings}.
 *
...
class NominalValueRowFilterSettingsTest extends DefaultNodeSettingsSnapshotTest {
    ...
    private static SnapshotTestConfiguration getConfig() {
        ...
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(NominalValueRowFilterSettings.class) //
    ...
    private static NominalValueRowFilterSettings createSettings() {
        return new NominalValueRowFilterSettings();
    }

    private static NominalValueRowFilterSettings readSettings() {
        try {
            var path = getSnapshotPath(NominalValueRowFilterSettings.class).getParent().resolve("node_settings")
            ...
            try (var fis = new FileInputStream(path.toFile())) {
                ...
                return DefaultNodeSettings.loadSettings(nodeSettings.getNodeSettings(SettingsType.MODEL.getConfigKey()),
                    NominalValueRowFilterSettings.class);
            }
