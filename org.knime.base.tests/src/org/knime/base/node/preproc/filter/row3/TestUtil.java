 ...
 *
 * History
 *   2 Oct 2025 (Manuel Hotz, KNIME GmbH, Konstanz, Germany): created
 */
...
/**
 * Utilities for row filter tests.
 *
...
public final class TestUtil {
    ...
    /**
     * State provider initializer that complains if non-overwritten methods are called.
     */
    public abstract static class TestInitializer implements StateProvider.StateProviderInitializer {
