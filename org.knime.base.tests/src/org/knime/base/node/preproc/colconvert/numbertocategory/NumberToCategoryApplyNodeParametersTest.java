...
/**
 * Snapshot test for {@link NumberToCategoryApplyNodeParameters}.
 */
@SuppressWarnings("restriction")
final class NumberToCategoryApplyNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    NumberToCategoryApplyNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(NumberToCategoryApplyNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static NumberToCategoryApplyNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(NumberToCategoryApplyNodeParameters.class).getParent().resolve("node_settings")
                .resolve("NumberToCategoryApplyNodeParameters.xml");
    ...
    private static DataTableSpec createDataTableSpec() {
        return new DataTableSpec(
            new DataColumnSpecCreator("category_col", IntCell.TYPE).createSpec()
        );
    }
