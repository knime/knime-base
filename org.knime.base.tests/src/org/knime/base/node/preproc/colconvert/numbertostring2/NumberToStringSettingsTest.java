...
/**
 * Tests for the NumberToStringSettings choices provider.
 *
 * @author Manuel Hotz, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("restriction")// WebUI* classes
class NumberToStringSettingsTest {
    ...
    void testColumnChoicesProvider() {
        ...
        assertArrayEquals(expected, choices, "Wrong numerical column choices.");
    }
}
