...
final class RecursiveLoopEndDynamicNodeParametersTest extends DefaultNodeSettingsSnapshotTest {
    ...
    private static PortObjectSpec[] createInputPortSpecs() {
        // 2 Collector ports, 2 Recursion ports
        return new PortObjectSpec[]{
            new DataTableSpec(new String[]{"Collector 1"}, new DataType[]{StringCell.TYPE}),
            new DataTableSpec(new String[]{"Collector 2"}, new DataType[]{StringCell.TYPE}),
            new DataTableSpec(new String[]{"Recursion 1"}, new DataType[]{StringCell.TYPE}),
            new DataTableSpec(new String[]{"Recursion 2"}, new DataType[]{StringCell.TYPE})
        };
    }
