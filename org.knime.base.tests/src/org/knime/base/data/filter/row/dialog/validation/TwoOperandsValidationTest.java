...
public class TwoOperandsValidationTest extends AbstractMultipleOperandsValidationTest {

    @Mock
    private Operator m_operator;

    public TwoOperandsValidationTest() {
        super(new TwoOperandsValidation());
    }

    @Test
    public void shouldAllowTwoValuesOnly() {
        // given
        final TwoOperandsValidation validation = new TwoOperandsValidation();
