...
import org.knime.base.data.filter.row.dialog.validation.MultipleOperandsValidation;
import org.knime.core.data.def.StringCell;
import org.mockito.Mock;

@SuppressWarnings("javadoc")
public class MultipleOperandsValidationTest extends AbstractMultipleOperandsValidationTest {

    @Mock
    private Operator m_operator;

    public MultipleOperandsValidationTest() {
        super(new MultipleOperandsValidation());
    }

    @Test
    public void shouldFail_whenNoValuesProvided() {
        // given
        final MultipleOperandsValidation validation = new MultipleOperandsValidation();
