 ...
 */
public class SingletonDoubleIteratorTest {

    /**
     *
     */
    private static final double VALUE = 5.0;
    private SingletonDoubleIterator m_testInstance;

    @Before
    public void init() {
        m_testInstance = new SingletonDoubleIterator(VALUE);
    }
    ...
    public void testNext() throws Exception {
        assertEquals(VALUE, m_testInstance.next(), 1e-10);
    }
