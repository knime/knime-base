...
public abstract class TransformationParametersUpdatesTest<R extends WidgetGroup, T> extends LocalWorkflowContextTest {
     ...
     */
    protected abstract TransformationParameters<?> getTransformationSettings(R settings);

    private TransformationParameters<?> getTransformationSettings() {
    ...
    protected void testTableSpecSettingsProvider(final Function<UpdateSimulator, UpdateSimulatorResult> simulate)
        throws IOException {
    ...
    protected void testTransformationElementSettingsProvider(
    ...
    protected TableSpecSettingsWithFsLocation[] getTableSpecsValueUpdate(final UpdateSimulatorResult simulatorResult) {
        return (TableSpecSettingsWithFsLocation[])simulatorResult
            .getValueUpdateAt(combineWithPathToTransformationSettings("specs"));
    }
