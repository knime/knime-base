...
class LocalConnectorNodeParameters implements NodeParameters {
    ...
    @ValueReference(CustomWorkingDirectoryRef.class)
    ...
    static class CustomWorkingDirectoryRef implements ParameterReference<Boolean> {
    }

    static final class ShowCustomWorkingDirectory implements EffectPredicateProvider {
        @Override
        public EffectPredicate init(final PredicateInitializer i) {
            return i.getBoolean(CustomWorkingDirectoryRef.class).isTrue();
        }
    }
    ...
    public void validate() throws InvalidSettingsException {
        if (m_useCustomWorkingDirectory) {
            ...
            CheckUtils.checkSetting( //
                !StringUtils.isBlank(m_workingDirectory) && Paths.get(m_workingDirectory).isAbsolute(), //
