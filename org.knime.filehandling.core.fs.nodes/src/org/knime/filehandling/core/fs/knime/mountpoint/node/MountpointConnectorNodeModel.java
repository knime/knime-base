...
/**
 * Mountpoint FS Connector node.
 *
 * @author Alexander Bondaletov
 */
public class MountpointConnectorNodeModel extends NodeModel {
     ...
     */
    protected MountpointConnectorNodeModel() {
    ...
    private FileSystemPortObjectSpec createSpec() {
        var factory = MountpointConnectorFSConnectionFactory.create(m_settings);
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        m_fsConnection = MountpointConnectorFSConnectionFactory.create(m_settings).createFSConnection();
