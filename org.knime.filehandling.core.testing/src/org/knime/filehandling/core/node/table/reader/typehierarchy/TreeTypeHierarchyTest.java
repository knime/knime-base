...
import org.knime.filehandling.core.node.table.reader.typehierarchy.TreeTypeHierarchy.TreeTypeHierarchyBuilder;
...
public class TreeTypeHierarchyTest {
	...
	public void testTreeTypeHierarchyBuilderRejectsDuplicateKeys() {
	...
	public void testTreeNodeEquals() {
		TreeTypeHierarchy.TreeNode<String, Integer> elfriede = new TreeTypeHierarchy.TreeNode<>(null,
				new TestingTypeTester(ELFRIEDE, 0));
		...
		TreeTypeHierarchy.TreeNode<String, Integer> emma = new TreeTypeHierarchy.TreeNode<>(elfriede,
				new TestingTypeTester(EMMA, 1));
		TreeTypeHierarchy.TreeNode<String, Integer> hans = new TreeTypeHierarchy.TreeNode<>(elfriede,
				new TestingTypeTester(HANS, 2));
