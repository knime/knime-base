 ...
 */
final class FileSystemChooserTestNodeDialog extends DefaultNodeSettingsPane {

	FileSystemChooserTestNodeDialog(final SettingsModelFileSystem settings) {
		final FlowVariableModel fvm = createFlowVariableModel(settings.getKeysForFSLocation(),
				FSLocationSpecVariableType.INSTANCE);
		addDialogComponent(new DialogComponentFileSystem(settings, fvm));
	}
