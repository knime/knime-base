...
/**
 * Space FS Connector node.
 *
 * @author Zkriya Rakhimberdiyev
 */
public class SpaceConnectorNodeModel extends NodeModel {
     ...
     */
    protected SpaceConnectorNodeModel() {
    ...
    private FileSystemPortObjectSpec createSpec() {
        ...
        return new FileSystemPortObjectSpec(factory.getFSType().getTypeId(), //
            m_fsId, //
