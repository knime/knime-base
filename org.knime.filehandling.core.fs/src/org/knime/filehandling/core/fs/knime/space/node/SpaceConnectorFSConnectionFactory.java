...
/**
 * Factory class used by the {@link SpaceConnectorNodeModel} node.
 * Creates different types of FS Connections according to provided settings.
 *
 * @author Zkriya Rakhimberdiyev
 */
abstract class SpaceConnectorFSConnectionFactory {
    ...
    private static class CustomSpaceFactory extends SpaceConnectorFSConnectionFactory {
        ...
        private SpaceFSConnectionConfig createFSConnectionConfig() {
            return new SpaceFSConnectionConfig( //
                ...
                m_settings.getSpaceIdModel().getStringValue(), //
    ...
    private static class RelativeToCurrentSpaceFactory extends SpaceConnectorFSConnectionFactory {
        ...
        @Override
        public FSType getFSType() {
            return FSType.RELATIVE_TO_SPACE;
        }

        @Override
        public FSLocationSpec getFSLocationSpec() {
            return createFSConnectionConfig().getFSLocationSpec();
        }
