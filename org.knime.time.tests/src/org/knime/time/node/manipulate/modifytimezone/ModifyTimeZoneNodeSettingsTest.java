...
public class ModifyTimeZoneNodeSettingsTest extends DefaultNodeSettingsSnapshotTest { // NOSONAR
    ...
    protected ModifyTimeZoneNodeSettingsTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(ModifyTimeZoneNodeSettings.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static ModifyTimeZoneNodeSettings readSettings() {
        try {
            var path = getSnapshotPath(ModifyTimeZoneNodeSettings.class).getParent().resolve("node_settings")
                .resolve("ModifyTimeZoneNodeSettings.xml");
            try (var fis = new FileInputStream(path.toFile())) {
                var nodeSettings = NodeSettings.loadFromXML(fis);
                return DefaultNodeSettings.loadSettings(nodeSettings.getNodeSettings(SettingsType.MODEL.getConfigKey()),
                    ModifyTimeZoneNodeSettings.class);
            }
