...
class DateTimeFormatManagerNodeSettingsTest extends DefaultNodeSettingsSnapshotTest { // NOSONAR
    ...
    private static final String[] MOCKED_HISTORY_LIST = new String[]{};

    private MockedStatic<ZonedDateTime> m_mockedStaticLocalZonedDateTime;

    private MockedStatic<ZoneId> m_mockedStaticZoneId;

    private MockedStatic<StringHistory> m_mockedStaticStringHistory;
    ...
    void setDefaults() {
        ...
        m_mockedStaticStringHistory = Mockito.mockStatic(StringHistory.class, Mockito.CALLS_REAL_METHODS);
        StringHistory mockedStringHistory = mock(StringHistory.class);
        m_mockedStaticStringHistory.when(() -> StringHistory.getInstance(anyString(), anyInt()))
            .thenReturn(mockedStringHistory);
        when(mockedStringHistory.getHistory()).thenReturn(MOCKED_HISTORY_LIST);
    }
    ...
    void resetDefaults() {
        ...
        m_mockedStaticStringHistory.close();
    }

    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            .withInputPortObjectSpecs(TEST_TABLE_SPECS) //
            .testJsonFormsForModel(DateTimeFormatManagerNodeSettings.class) //
            .build();
    }
