...
public class DurationToNumberNodeSettingsTest extends DefaultNodeSettingsSnapshotTest { // NOSONAR
    ...
    protected DurationToNumberNodeSettingsTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(DurationToNumberNodeSettings.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static DurationToNumberNodeSettings readSettings() {
        try {
            var path = getSnapshotPath(DurationToNumberNodeSettings.class).getParent().resolve("node_settings")
