...
final class DateTimeCellFilterParametersSnapshotTest extends DefaultNodeSettingsSnapshotTest {
    ...
    DateTimeCellFilterParametersSnapshotTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            .testJsonFormsForModel("LocalDate default", LocalDateCellFilterParameters.class) //
            .testJsonFormsWithInstance("LocalDate from 5.9", SettingsType.MODEL,
                () -> loadXml("LocalDateCellFilterParameters_5_9.xml", LocalDateCellFilterParameters.class)) //
            .testJsonFormsWithInstance("LocalDate from 5.12", SettingsType.MODEL,
                () -> loadXml("LocalDateCellFilterParameters_5_12.xml", LocalDateCellFilterParameters.class)) //
            .testJsonFormsForModel("LocalTime default", LocalTimeCellFilterParameters.class) //
            .testJsonFormsWithInstance("LocalTime from 5.9", SettingsType.MODEL,
                () -> loadXml("LocalTimeCellFilterParameters_5_9.xml", LocalTimeCellFilterParameters.class)) //
            .testJsonFormsWithInstance("LocalTime from 5.12", SettingsType.MODEL,
                () -> loadXml("LocalTimeCellFilterParameters_5_12.xml", LocalTimeCellFilterParameters.class)) //
            .testJsonFormsForModel("LocalDateTime default", LocalDateTimeCellFilterParameters.class) //
            .testJsonFormsWithInstance("LocalDateTime from 5.9", SettingsType.MODEL,
                () -> loadXml("LocalDateTimeCellFilterParameters_5_9.xml", LocalDateTimeCellFilterParameters.class)) //
            .testJsonFormsWithInstance("LocalDateTime from 5.12", SettingsType.MODEL,
                () -> loadXml("LocalDateTimeCellFilterParameters_5_12.xml", LocalDateTimeCellFilterParameters.class)) //
            .testJsonFormsForModel("ZonedDateTime default", ZonedDateTimeCellFilterParameters.class) //
            .testJsonFormsWithInstance("ZonedDateTime from 5.9", SettingsType.MODEL,
                () -> loadXml("ZonedDateTimeCellFilterParameters_5_9.xml", ZonedDateTimeCellFilterParameters.class)) //
            .testJsonFormsWithInstance("ZonedDateTime from 5.12", SettingsType.MODEL,
                () -> loadXml("ZonedDateTimeCellFilterParameters_5_12.xml", ZonedDateTimeCellFilterParameters.class)) //
            .build();
    }

    private static <T extends NodeParameters> T loadXml(final String filename, final Class<T> clazz) {
        try {
            final var path = getSnapshotPath(LocalDateCellFilterParameters.class).getParent().resolve("node_settings")
