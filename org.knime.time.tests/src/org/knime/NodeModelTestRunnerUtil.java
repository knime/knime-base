...
final public class NodeModelTestRunnerUtil {
     ...
     * @param success The status of the test run
     */
    public record TestOutput(BufferedDataTable outputTable, DataCell firstCell, DataCell lastCell, boolean success) {
    }
    ...
    public <T extends DefaultNodeSettings> TestOutput setupAndExecuteWorkflow(final T settings,
        ...
        try {
            ...
            fail(e.getMessage());
            return new TestOutput(null, null, null, false);
        }
        ...
        if (outputTable == null || outputTable.size() == 0) {
            return new TestOutput(outputTable, null, null, success);
        }
        ...
        return new TestOutput(outputTable, firstCell, lastCell, success);
    }
