 ...
 */
final class CompressFileChooserNodeDialog extends AbstractCompressNodeDialog<CompressFileChooserNodeConfig> {

    private static final String FILE_INPUT_HISTORY_ID = "compress_input_files_history";
