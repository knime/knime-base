...
public abstract class AbstractPathVariableArrayPersistor implements NodeParametersPersistor<PathVariable[]> {
    ...
    public String[][] getConfigPaths() {
        /* Intentionally empty to avoid creating unused automatic flow variables. Instead, the node generates
         * flow variables as regular output based on its configuration.
         */
        return new String[][]{ //
