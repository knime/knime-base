...
final class PathToStringNodeParameters implements NodeParameters {
    ...
    @Widget(title = "Output mode", description = """
            ...
            """)
    @ValueSwitchWidget
    @Persist(configKey = PathToStringNodeModel.CFG_GENERATED_COLUMN_MODE)
    ...
    static final class FSLocationColumnChoicesProvider extends CompatibleColumnsProvider {

        protected FSLocationColumnChoicesProvider() {
    ...
    static final class ColumnNameAutoGuesser extends ColumnNameAutoGuessValueProvider {
        ...
        protected Optional<DataColumnSpec> autoGuessColumn(final NodeParametersInput parametersInput) {
            ...
            return ColumnSelectionUtil.getCompatibleColumnsOfFirstPort(parametersInput, FSLocationValue.class).stream()
                .findFirst();
        }
    }
    ...
    static final class OutputModeIsAppendPredicate implements EffectPredicateProvider {
        ...
        public EffectPredicate init(final PredicateInitializer i) {
            ...
            return i.getEnum(OutputModeRef.class).isOneOf(PathToStringNodeParameters.OutputMode.APPEND_NEW);
        }
