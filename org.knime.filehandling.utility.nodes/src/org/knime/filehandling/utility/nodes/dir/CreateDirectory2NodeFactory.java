...
public final class CreateDirectory2NodeFactory extends ConfigurableNodeFactory<CreateDirectory2NodeModel> {
    ...
    protected NodeDialogPane createNodeDialogPane(final NodeCreationConfiguration creationConfig) {
        return new CreateDirectory2NodeDialog(creationConfig.getPortConfig().orElseThrow(IllegalStateException::new));
    }

    @Override
    public NodeView<CreateDirectory2NodeModel> createNodeView(final int viewIndex,
