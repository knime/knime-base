...
/**
 * The NodeModel for the "Create File/Folder Variables" node.
 *
 * @author Timmo Waller-Ehrat, KNIME GmbH, Konstanz, Germany
 */
final class CreatePathVariablesNodeModel extends NodeModel {

    private final CreatePathVariablesNodeConfig m_config;

    private final NodeModelStatusConsumer m_statusConsumer;

    CreatePathVariablesNodeModel(final PortsConfiguration portsConfig) {
