 ...
 */
public final class DeleteFilesAndFoldersTableNodeFactory extends ConfigurableNodeFactory<DeleteFilesAndFoldersTableNodeModel> {
    ...
    protected DeleteFilesAndFoldersTableNodeModel createNodeModel(final NodeCreationConfiguration creationConfig) {
        return new DeleteFilesAndFoldersTableNodeModel(creationConfig.getPortConfig().orElseThrow(IllegalStateException::new));
    }

    @Override
    protected NodeDialogPane createNodeDialogPane(final NodeCreationConfiguration creationConfig) {
        return new DeleteFilesAndFoldersTableNodeDialog(creationConfig.getPortConfig().orElseThrow(IllegalStateException::new));
    }
    ...
    @Override
    public NodeView<DeleteFilesAndFoldersTableNodeModel> createNodeView(final int viewIndex, final DeleteFilesAndFoldersTableNodeModel nodeModel) {
        return null;
    }
