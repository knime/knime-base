 ...
 */
public final class FileFolderMetaInfoNodeFactory extends ConfigurableNodeFactory<FileFolderMetaInfoNodeModel> {
    ...
    protected NodeDialogPane createNodeDialogPane(final NodeCreationConfiguration creationConfig) {
        return new FileFolderMetaInfoNodeDialog(creationConfig.getPortConfig().orElseThrow(IllegalStateException::new));
    }
