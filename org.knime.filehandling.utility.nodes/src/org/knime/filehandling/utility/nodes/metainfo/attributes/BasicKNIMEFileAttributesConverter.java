...
/**
 * Enum supporting the creation of {@link DataCell}s with respect to {@link BasicFileAttributes} based on
 * {@link KNIMEFileAttributes}.
 *
 * @author Mark Ortmann, KNIME GmbH, Berlin, Germany
 */
public enum BasicKNIMEFileAttributesConverter implements KNIMEFileAttributesConverter {

        /**
         * Indicates whether or not the path is a file or folder/directory?
         */
        DIRECTORY("Directory", BooleanCell.TYPE, k -> BooleanCellFactory.create(k.isDirectory())),

        /**
         * Size of the file/folder in bytes.
         */
        SIZE("Size", LongCell.TYPE, k -> LongCellFactory.create(k.size())),

        /**
         * Size of the file/folder in bytes, in human readable form.
         */
        HUMANSIZE("Size (human readable)", StringCell.TYPE,
            k -> StringCellFactory.create(FileUtils.byteCountToDisplaySize(k.size()))),

        /**
         * Last time the file/folder was modified.
         */
        LAST_MODIFIED_DATE("Last modified date", LocalDateTimeCellFactory.TYPE, k -> {
         ...
         */
        CREATION_DATE("Creation date", LocalDateTimeCellFactory.TYPE, k -> {
         ...
         */
        EXISTS("Exists", BooleanCell.TYPE, k -> BooleanCellFactory.create(true));
     ...
     */
    private BasicKNIMEFileAttributesConverter(final String name, final DataType type,
