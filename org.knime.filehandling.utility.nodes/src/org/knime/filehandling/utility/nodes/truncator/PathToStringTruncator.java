...
/**
 * A path to string truncator modifies a given path and returns the resulting path as a string.
 *
 * @author Mark Ortmann, KNIME GmbH, Berlin, Germany
 */
@FunctionalInterface
public interface PathToStringTruncator { //NOSONAR descriptive names are more important
     ...
     */
    String getTruncatedString(final Path path);
