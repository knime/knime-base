 ...
 */
public class KNIMEFileAttributesWithoutPermissionsTest extends KNIMEFileAttributesTest {

    @Override
    KNIMEFileAttributes initAttributes(final boolean calcFolderSize) throws IOException {
        return new KNIMEFileAttributesWithoutPermissions(getPathMock(), calcFolderSize, getFileAttributesMock());
    }
