...
/**
 * Tests {@link KNIMEFileAttributesWithPermissions}.
 *
 * @author Mark Ortmann, KNIME GmbH, Berlin, Germany
 */
public class KNIMEFileAttributesWithPermissionsTest extends KNIMEFileAttributesTest {

    private static final boolean IS_READABLE = false;

    private static final boolean IS_WRITABLE = true;

    private static final boolean IS_EXECUTABLE = false;

    @Override
    KNIMEFileAttributes initAttributes(final boolean calcFolderSize) throws IOException {
        return new KNIMEFileAttributesWithPermissions(getPathMock(), calcFolderSize, getFileAttributesMock(),
