...
/**
 * Unit tests for {@link FSLocationSpecVariableType}.
 * 
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
public class FSLocationSpecVariableTypeTest {

    private static final String KEY = "test";

    private static final FSLocationSpecVariableType TEST_INSTANCE = FSLocationSpecVariableType.INSTANCE;

    @Test
    public void testGetSimpleType() {
        assertEquals(FSLocationSpec.class, TEST_INSTANCE.getSimpleType());
    }

    private static FSLocationSpec get(final FlowVariable flowVar) {
        return flowVar.getValue(FSLocationSpecVariableType.INSTANCE);
    }

    @Test
    public void testloadValue() throws InvalidSettingsException {
        NodeSettings settings = new NodeSettings("Test");
        FSLocationSpec location = new DefaultFSLocationSpec("foo", "bar");
    ...
    public void testGetIdentifier() {
        assertEquals("FSLocationSpec", TEST_INSTANCE.getIdentifier());
    }

    @Test
    public void testDefaultValue() {
        assertEquals(FSLocationSpec.NULL, get(new FlowVariable("var", TEST_INSTANCE)));
    }
    ...
    public void testCreateFromSuccess() throws InvalidSettingsException, InvalidConfigEntryException {
        Config config = mockEmptyConfig();
        assertEquals(FSLocationSpec.NULL, TEST_INSTANCE.createFrom(config, KEY));
    }
