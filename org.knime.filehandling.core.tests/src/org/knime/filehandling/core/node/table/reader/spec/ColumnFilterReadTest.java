...
/**
 * Unit tests for ColumnFilterRead.
 *
...
public class ColumnFilterReadTest {
    ...
    /**
     * Tests if the next method behaves correctly.
     *
     * @throws IOException never thrown
     */
    ...
    public void testSize() throws IOException {
        ...
        assertEquals(1, testInstance.next().size());
    ...
    public void testGet() throws IOException {
        ...
        assertEquals("foo", randomAccessible.get(0));
        assertEquals("bar", randomAccessible.get(1));
    }
