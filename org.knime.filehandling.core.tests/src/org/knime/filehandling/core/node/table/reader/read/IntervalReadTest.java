...
/**
 * Contains unit tests for IntervalRead.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
@RunWith(MockitoJUnitRunner.class)
@SuppressWarnings("resource") // there are no actual ressources allocated
